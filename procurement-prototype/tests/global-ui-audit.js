...
async function run() {
  ...
  await auditVisiblePage(page, "user-a-request-worksheet-mfg");
  await page.locator('[data-request-worksheet-tab="Non-MFG"]').click();
  await auditVisiblePage(page, "user-a-request-worksheet-non-mfg");
  ...
  if (editDemandCount > 0) {
    ...
    await auditVisiblePage(page, "user-a-demand-detail-modal");
