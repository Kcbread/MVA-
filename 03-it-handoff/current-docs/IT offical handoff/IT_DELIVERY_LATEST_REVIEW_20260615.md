...
The live handoff documentation under `03-it-handoff/current-docs/` has been reviewed against the current repo context on 2026-06-15.
...
- `03-it-handoff/current-docs/IT offical handoff.zip`
- `03-it-handoff/current-docs/IT_MEETING_PACKAGE_20260604.zip`
- `03-it-handoff/handoff-delivery/MVA_PROCUREMENT_CONTAINERIZED_IT_HANDOFF_20260608.zip`
- `03-it-handoff/handoff-delivery/20260608/`
...
- `05-engineering-source/procurement-prototype/_context/roles/*.md`
- `05-engineering-source/procurement-prototype/_context/flows/*.md`
- `05-engineering-source/procurement-prototype/_context/modules/*.md`
- `05-engineering-source/procurement-prototype/db/workflow-api-table-map.zh-TW.md`
- `05-engineering-source/procurement-prototype/db/schema.sql`
- `05-engineering-source/procurement-prototype/db/migrations/*.sql`
