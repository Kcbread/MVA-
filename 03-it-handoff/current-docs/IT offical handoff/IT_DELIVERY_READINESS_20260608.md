...
The live Markdown and SQL files under `docs-current/` and `db/` are the current reviewed handoff baseline. Existing zip files and `03-it-handoff/handoff-delivery/20260608/` are historical snapshots unless rebuilt after the 2026-06-15 review.
