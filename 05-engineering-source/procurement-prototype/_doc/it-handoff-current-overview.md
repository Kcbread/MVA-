...
| OM Purchasing | Assigned OM execution | PAS Demand No, My Quote Result, quote screenshot/image, quote Excel, quote validity, Export Package | Assigned row context, Quotation DB, export readiness |
...
5. OM Purchasing records PAS Demand No and My Quote Result; the quote screen maps to the PAS Quote Result workflow stage.
...
| OM Quote Result | Quote result card/table | OM Purchasing | PAS Material No, vendor, price, quote date, valid until, screenshot/image, Excel |
