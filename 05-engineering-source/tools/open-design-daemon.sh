...
usage() {
  cat <<'EOF'
Usage:
  bash 05-engineering-source/tools/open-design-daemon.sh start
  bash 05-engineering-source/tools/open-design-daemon.sh stop
  bash 05-engineering-source/tools/open-design-daemon.sh restart
  bash 05-engineering-source/tools/open-design-daemon.sh status
  bash 05-engineering-source/tools/open-design-daemon.sh logs
EOF
}
