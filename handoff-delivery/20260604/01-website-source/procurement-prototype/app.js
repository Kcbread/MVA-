...
const QUOTE_EXPIRING_SOON_DAYS = 14;
...
const roleProfiles = {
  ...
  manager: { name: "Manager B", dept: "MFG", functionName: "Approver", defaultView: "manager" },
...
const OM_USER_CONFIRMED = "User A Confirmed";
...
let adminApprovalSetup = {
  ...
  users: [
    ...
    { id: "manager-b", name: "Manager B", email: "manager-b@fih-foxconn.com", department: "MFG", role: "manager" },
...
const USER_CANCELLED_REQUEST = "Cancelled by User A";
const AMENDMENT_WAITING_OM = "Waiting OM Amendment";
const AMENDMENT_WAITING_USER_CONFIRM = "Waiting User A Amendment Confirmation";
...
let currentReuseMode = "item";
let managerSelections = new Set();
...
function seedNonMfgDepartment(process, station, level2 = "", level3 = "", name = "") {
  return "";
}
...
function makePurchaseRecords() {
  ...
  const catalog = [
    ["Keyboard", "生產設備與工具", "IT硬體與設備", "周邊", "MX Keys / USB-C", "Mainline", "CG", 42],
    ["Wireless Mouse", "生產設備與工具", "IT硬體與設備", "周邊", "2.4G wireless mouse", "Packaging", "Hybrid", 28],
    ["Type C Cable", "生產設備與工具", "IT線材與耗材", "USB線材", "1.5m 100W cable", "Mainline", "CG", 3],
    ["Barcode Scanner", "生產設備與工具", "IT硬體與設備", "掃碼槍主體", "2D handheld scanner", "Mainline", "Trace", 145],
    ["Label Printer", "生產設備與工具", "IT硬體與設備", "印表機", "300dpi industrial label printer", "Mainline", "Trace", 680],
    ["VHX Microscope", "生產設備與工具", "產線通用設備", "檢測設備", "4K digital inspection set", "Mainline", "FA", 10000],
    ["Torque Screwdriver", "生產設備與工具", "設備工程工具", "輔助工具", "0.05-2.0 Nm torque driver", "Mainline", "Assembly", 260],
    ["ESD Mat", "生產設備與工具", "耗材", "生產耗材", "900x600mm ESD mat", "Mainline", "ESD", 36],
    ["ESD Wrist Strap", "生產設備與工具", "安全相關", "安全防護", "Adjustable ESD wrist strap", "Mainline", "ESD", 8],
    ["Thermal Chamber", "生產設備與工具", "產線通用設備", "測試設備", "-40C to 150C chamber", "Lab", "ORT", 18000],
    ["Data Logger", "生產設備與工具", "產線通用設備", "檢測設備", "16 channel logger", "Lab", "ORT", 950],
    ["Fixture Base", "生產設備與工具", "治具與夾具", "治具與夾具", "Aluminum CNC base", "Mainline", "FATP", 420],
    ["Pogo Pin Fixture", "生產設備與工具", "治具與夾具", "治具與夾具", "Custom pin layout", "Mainline", "FATP", 1350],
    ["Laptop", "生產設備與工具", "IT硬體與設備", "電腦主機", "i7 / 32GB / 1TB", "Office", "NPI", 1450],
    ["Monitor", "生產設備與工具", "IT硬體與設備", "螢幕", "27 inch QHD monitor", "Office", "NPI", 260],
    ["Network Switch", "生產設備與工具", "IT線材與耗材", "網路線材", "24 port managed switch", "Office", "IT", 880],
    ["Screw Feeder", "生產設備與工具", "產線通用設備", "生產設備", "M1.2-M2.0 automatic feeder", "Mainline", "Assembly", 2200],
    ["Ionizer Fan", "生產設備與工具", "產線通用設備", "工作站與設備", "Bench top ionizer", "Mainline", "ESD", 320],
    ["Workstation PC", "生產設備與工具", "IT硬體與設備", "電腦主機", "RTX GPU / 64GB workstation", "Office", "TE", 2400],
    ["Digital Caliper", "生產設備與工具", "設備工程工具", "輔助工具", "0-150mm digital caliper", "Lab", "IQC", 85],
    ["Height Gauge", "生產設備與工具", "產線通用設備", "檢測設備", "0-600mm height gauge", "Lab", "IQC", 1250],
    ["Vision Camera", "生產設備與工具", "IT硬體與設備", "攝影設備", "12MP GigE camera", "Mainline", "AOI", 1680],
    ["Lens", "生產設備與工具", "設備配件", "設備零組件", "25mm C mount lens", "Mainline", "AOI", 430],
    ["Light Controller", "生產設備與工具", "設備配件", "設備電源配件", "4 channel controller", "Mainline", "AOI", 390],
    ["Ring Light", "生產設備與工具", "設備配件", "設備零組件", "Red 90mm ring light", "Mainline", "AOI", 210],
    ["Cleanroom Wiper", "生產設備與工具", "耗材", "無塵室耗材", "9x9 inch lint-free wiper", "Mainline", "Cleanroom", 12],
    ["Protective Film", "生產設備與工具", "耗材", "保護膜", "PET protective film roll", "Mainline", "CG", 55],
    ["Tray", "生產設備與工具", "耗材", "托盤", "ESD plastic tray", "Mainline", "Material", 18],
    ["Label Roll", "生產設備與工具", "耗材", "標籤", "50x30mm thermal label", "Mainline", "Trace", 9],
    ["Carton", "生產設備與工具", "包材", "包裝材料", "Export carton box", "Packaging", "Pack", 2],
    ["Foam Insert", "生產設備與工具", "包材", "緩衝保護材料", "EPE foam insert", "Packaging", "Pack", 1],
    ["Tape", "生產設備與工具", "包材", "膠帶", "48mm packing tape", "Packaging", "Pack", 1],
    ["Tool Cart", "生產設備與工具", "搬運倉儲物流", "搬運工具", "3 layer tool cart", "Mainline", "Material", 160],
    ["Material Rack", "生產設備與工具", "搬運倉儲物流", "倉儲設備", "Adjustable rack", "Warehouse", "WH", 380],
    ["Pallet Jack", "生產設備與工具", "搬運倉儲物流", "搬運設備", "Manual pallet jack", "Warehouse", "WH", 620],
    ["Security Service", "服務", "委外服務", "保全服務", "Monthly guard service", "Facility", "Gate", 1800],
    ["Training Service", "服務", "委外服務", "培訓", "ESD training package", "Office", "HR", 350],
    ["Repair Service", "服務", "委外服務", "技術&維修服務", "Equipment repair visit", "Mainline", "Maintenance", 520],
    ["NPI Shipment", "服務", "運輸服務對外", "NPI 運輸", "Sample shipment to customer", "NPI", "Logistics", 260],
    ["MP Shipment", "服務", "運輸服務對外", "MP 運輸", "Mass production shipment", "MP", "Logistics", 980],
    ["Waste Disposal", "服務", "工程服務", "廢料處理", "Monthly waste disposal", "Facility", "EHS", 300],
    ["Calibration Service", "服務", "檢驗與校正服務", "檢驗與校正服務", "Gauge calibration", "Lab", "IQC", 75],
    ["Power Supply", "廠務基礎設施", "電力與機電設備", "電源設備", "24V industrial power supply", "Facility", "Utility", 120],
    ["Power Cable", "廠務基礎設施", "電力與機電設備", "電纜", "3 phase power cable", "Facility", "Utility", 8],
    ["Breaker", "廠務基礎設施", "電力與機電設備", "電機零件", "Circuit breaker", "Facility", "Utility", 28],
    ["Water Pipe", "廠務基礎設施", "廠務工程耗材", "水電材料", "PVC pipe", "Facility", "Utility", 4],
    ["Office Chair", "行政與人資", "辦公設備與家具", "椅子", "Ergonomic office chair", "Office", "Admin", 130],
    ["Office Desk", "行政與人資", "辦公設備與家具", "桌子", "1400mm office desk", "Office", "Admin", 180],
    ["Office Supplies", "行政與人資", "辦公用品", "辦公用品", "Stationery pack", "Office", "Admin", 25],
    ["Cleaning Supplies", "行政與人資", "辦公用品", "清潔用品", "General cleaning pack", "Office", "Admin", 35],
  ];
  const vendors = ["HOP LONG", "FPT Trading", "Keyence", "MITUTOYO", "SATO", "OMRON"];

  const records = catalog.map((item, index) => {
    const project = PROJECTS[index % PROJECTS.length];
    const stageQtys = STAGES.reduce((values, stage, stageIndex) => {
      values[stage] = (index + stageIndex) % 4 === 0 ? 0 : ((index + stageIndex) % 5) + 1;
      return values;
    }, {});
    const qty = totalQty(stageQtys);
    const month = String((index % 9) + 1).padStart(2, "0");
    const day = String((index % 24) + 1).padStart(2, "0");
    const quoteMonth = index % 4 === 0 ? "03" : String((index % 5) + 7).padStart(2, "0");
    const quoteDateMonth = index % 4 === 0 ? "01" : String(Math.max(1, Number(quoteMonth) - 2)).padStart(2, "0");
    const price = item[7] + (index % 5) * 12;

    const identitySource = {
      name: item[0],
      spec: item[4],
    };
    const globalKey = globalItemKey(identitySource);

    return {
      id: `PO-${String(index + 1).padStart(3, "0")}`,
      poNo: `VNPO2026${month}${day}${String(index + 70).padStart(4, "0")}`,
      project,
      partNo: `PN-${project}-${String(8000 + index)}`,
      materialNo: "",
      factoryMaterialNo: createFactoryMaterialNo(identitySource),
      materialIdentityKey: materialIdentityKey(identitySource),
      vendorPartNo: `VPN-${project}-${String(8000 + index)}`,
      ...
      process: item[5],
      station: item[6],
      department: seedNonMfgDepartment(item[5], item[6], item[2], item[3], item[0]),
      unitPrice: price,
      qty,
      ...stageQtys,
      vendor: vendors[index % vendors.length],
      quoteDate: `2026-${quoteDateMonth}-${day}`,
      quoteExpiry: `2026-${quoteMonth}-${day}`,
      source: "history",
    };
  });
  ...
  const p26Computer = {
    id: "PO-P26-COMP-001",
    poNo: "VNPO202604150998",
    project: "P26",
    partNo: "PN-P26-IT-COMPUTER-001",
    factoryMaterialNo: createFactoryMaterialNo({ name: "Laptop Computer", spec: "ThinkPad T14 / i7 / 32GB / 1TB SSD" }),
    name: "Laptop Computer",
    level1: "生產設備與工具",
    level2: "IT硬體與設備",
    level3: "電腦主機",
    spec: "ThinkPad T14 / i7 / 32GB / 1TB SSD",
    process: "Office",
    station: "NPI",
    department: "",
    unitPrice: 1580,
    ...
    source: "history",
    itemMasterImage: "computer_master_placeholder.png",
    vnName: "Máy tính xách tay",
    noOfQuotation: "3",
  };
  p26Computer.globalItemKey = globalItemKey(p26Computer);
  p26Computer.globalItemId = globalItemIdForKey(p26Computer.globalItemKey);

  const omBuyTestItems = [
    {
      id: "PO-OMBUY-P26-PC-001",
      project: "P26",
      name: "PC",
      spec: "OM buy demand bucket; final model to be confirmed by OM Purchasing",
      unitPrice: 980,
      p10: 0,
      p11: 8,
      evt: 0,
    ...
    {
      id: "PO-OMBUY-P26-IPC-A-001",
      project: "P26",
      name: "IPC(A)",
      spec: "Industrial PC A bucket; OM to collect demand and confirm final model",
      unitPrice: 1450,
      p10: 0,
      p11: 4,
      evt: 2,
    ...
    {
      id: "PO-OMBUY-P26-IPC-AP-001",
      project: "P26",
      name: "IPC(A+)",
      spec: "Industrial PC A+ bucket; OM to confirm CPU / RAM / storage",
      unitPrice: 1680,
      p10: 0,
      p11: 2,
      evt: 2,
    ...
    {
      id: "PO-OMBUY-P26-IPC-APP-001",
      project: "P26",
      name: "IPC(A++)",
      spec: "Industrial PC A++ high-performance bucket; OM to confirm final model",
      unitPrice: 1980,
      p10: 0,
      p11: 1,
      evt: 1,
    ...
    {
      id: "PO-OMBUY-OR5-PC-001",
      project: "OR5",
      name: "PC",
      spec: "OM buy demand bucket; previous OR5 line opening usage",
      unitPrice: 960,
      p10: 0,
      p11: 0,
      evt: 6,
    ...
    {
      id: "PO-OMBUY-OR5-LAPTOP-001",
      project: "OR5",
      name: "Laptop",
      spec: "Business laptop bucket; OM to confirm final model",
      unitPrice: 1280,
      p10: 0,
      p11: 0,
      evt: 3,
    ...
    {
      id: "PO-OMBUY-OR5-MONITOR-001",
      project: "OR5",
      name: "Monitor",
      spec: "24 inch office monitor bucket",
      unitPrice: 180,
      p10: 0,
      p11: 0,
      evt: 8,
    ...
    {
      id: "PO-OMBUY-OR5-KEYBOARD-001",
      project: "OR5",
      name: "Keyboard",
      spec: "USB keyboard standard bucket",
      unitPrice: 18,
      p10: 0,
      p11: 0,
      evt: 10,
    ...
    {
      id: "PO-OMBUY-OR5-MOUSE-001",
      project: "OR5",
      name: "Mouse",
      spec: "Wired mouse standard bucket",
      unitPrice: 12,
      p10: 0,
      p11: 0,
      evt: 10,
    ...
    {
      id: "PO-OMBUY-P26-BARCODE-001",
      project: "P26",
      name: "Barcode Scanner",
      spec: "2D handheld scanner; final model required",
      unitPrice: 145,
      p10: 0,
      p11: 5,
      evt: 2,
    ...
    {
      id: "PO-OMBUY-OR5-LABEL-PRINTER-001",
      project: "OR5",
      name: "Label Printer",
      spec: "Industrial label printer; OM to confirm dpi and interface",
      unitPrice: 680,
      p10: 0,
      p11: 0,
      evt: 2,
    ...
    {
      id: "PO-OMBUY-P26-NETWORK-SWITCH-001",
      project: "P26",
      name: "Network Switch",
    ...
    {
      id: "PO-OMBUY-OR5-SOFTWARE-001",
      project: "OR5",
      name: "Software License",
      spec: "Engineering software subscription; OM to confirm license plan",
      unitPrice: 1200,
      p10: 0,
      p11: 0,
      evt: 1,
  ...
  const omBuyTestRecords = omBuyTestItems.map((item, index) => {
    const day = String(index + 2).padStart(2, "0");
    const record = {
      poNo: `OMBUY2026${day}`,
      partNo: `PN-${item.project}-OMBUY-${String(index + 1).padStart(3, "0")}`,
      factoryMaterialNo: createFactoryMaterialNo(item),
      level1: "生產設備與工具",
      level2: item.name.includes("Software") ? "軟體授權" : item.name.includes("Network") ? "IT線材與耗材" : "IT硬體與設備",
      level3: item.name.includes("Software") ? "軟體授權" : item.name.includes("Network") ? "網路線材" : item.name.includes("Label Printer") ? "印表機" : item.name.includes("Barcode") ? "掃碼槍主體" : item.name.includes("Monitor") ? "螢幕" : item.name.includes("Keyboard") || item.name.includes("Mouse") ? "周邊" : "電腦主機",
      process: "OM Buy",
      station: "Line Opening",
      department: "",
      qty: totalQty(item),
      vendor: index % 2 === 0 ? "FPT Trading" : "HOP LONG",
      quoteDate: "2026-04-20",
      quoteExpiry: "2026-10-20",
      source: "history",
      itemMasterImage: "om_buy_placeholder.png",
      vnName: item.name,
      noOfQuotation: "3",
      ...item,
    };
  ...
  return [...realMvaPurchaseRecords(), p26Computer, ...omBuyTestRecords, ...records];
}
...
function omCatalogRows(project = currentProject) {
  return OM_CATALOG_ITEMS.map((item) => omCatalogRecord(item, project));
}
...
function isOmRole(role = currentRole) {
  return ["om", "omLeader", "omMember", "admin"].includes(role);
}

function isOmLeaderRole(role = currentRole) {
  return ["omLeader", "admin"].includes(role);
}
...
async function loginWithApi(identifier, password) {
  const payload = await apiRequest("/api/login", {
    method: "POST",
    body: { identifier, account: identifier, email: identifier, password },
  });
...
async function restoreApiSession() {
  ...
  if (roleSelect) {
    ...
    roleSelect.title = "Server session decides the role in API mode.";
  }
  try {
...
function formatCurrencyFromVnd(value) {
  ...
  if (!amount) return "-";
  if (currencyDisplay === "USD") return formatUsd(amount / currentUsdToVndRate());
  return `${Math.round(amount).toLocaleString("en-US")} VND`;
}

function amountUsdFromVnd(vnd) {
  return Number(vnd || 0) / currentUsdToVndRate();
}

function amountVndFromUsd(usd) {
  return Number(usd || 0) * currentUsdToVndRate();
}

function formatMoneyFromUsd(value) {
  const amount = Number(value || 0);
  if (!amount) return "-";
  if (currencyDisplay === "VND") return `${Math.round(amountVndFromUsd(amount)).toLocaleString("en-US")} VND`;
...
function formatMoneyFromVnd(value) {
  const amount = Number(value || 0);
  if (!amount) return "-";
  if (currencyDisplay === "USD") return formatUsd(amountUsdFromVnd(amount));
  return `${Math.round(amount).toLocaleString("en-US")} VND`;
}
...
function formatCompactCurrencyFromVnd(value) {
  const amount = Number(value || 0);
  if (!amount) return "-";
  const displayAmount = currencyDisplay === "USD" ? amount / currentUsdToVndRate() : amount;
  const suffix = currencyDisplay === "USD" ? "" : " VND";
  const prefix = currencyDisplay === "USD" ? "$" : "";
...
function formatCompactCurrencyFromUsd(value) {
  const amount = Number(value || 0);
  if (!amount) return "-";
  const displayAmount = currencyDisplay === "VND" ? amountVndFromUsd(amount) : amount;
  const suffix = currencyDisplay === "VND" ? " VND" : "";
  const prefix = currencyDisplay === "USD" ? "$" : "";
  const abs = Math.abs(displayAmount);
  if (abs >= 1_000_000_000) return `${prefix}${(displayAmount / 1_000_000_000).toFixed(1).replace(/\.0$/, "")}B${suffix}`;
  if (abs >= 1_000_000) return `${prefix}${(displayAmount / 1_000_000).toFixed(1).replace(/\.0$/, "")}M${suffix}`;
...
function legacyPriceToUsd(row, field) {
  ...
  if (explicitVnd > 0) return amountUsdFromVnd(explicitVnd);
  const raw = Number(String(row?.[field] ?? "").replace(/,/g, ""));
  if (!Number.isFinite(raw) || raw <= 0) return 0;
  return raw > 1000 ? amountUsdFromVnd(raw) : raw;
}
...
function hasOmQuoteData(row) {
  return Boolean(row.vendor && effectiveUnitPrice(row) && row.quoteDate && omQuoteValidUntil(row) && row.quotationPdf && row.quotationExcel);
}
...
function stationBreakdownPhaseKey(row) {
  return STAGES.includes(row?.phase) ? row.phase : "";
}
...
function omBuyScopeReason(row) {
  ...
  if (status === OM_SCOPE_STANDARD) return "Matched standard OM demand bucket; final model is not required from User A.";
...
function updateRequestNeedDate(requestId, value) {
  ...
  requests = requests.map((row) => {
    ...
    return {
      ...
      needDateUpdatedBy: previous !== nextValue ? roleProfiles[currentRole]?.name || "User A" : row.needDateUpdatedBy,
    };
  });
...
function renderManagerStageTracking() {
  ...
  if (summaryTarget) {
    ...
    const budgetDone = rows.reduce((sum, row) => sum + row.budgetDone, 0);
    const prDone = rows.reduce((sum, row) => sum + row.prDone, 0);
    const poDone = rows.reduce((sum, row) => sum + row.poDone, 0);
    const arrived = rows.reduce((sum, row) => sum + row.arrived, 0);
    const lateAtRisk = rows.filter((row) => row.lateRows || row.pendingRows || row.notArrivedRows).length;
    const tempBudgetRows = rows.filter((row) => row.rows.some((raw) => isProgressTempBudget(raw)));
    const estimateAmount = tempBudgetRows.reduce((sum, row) => sum + row.rows.reduce((subtotal, raw) => subtotal + progressEstimatedAmount(raw), 0), 0);
    const biddingAmount = tempBudgetRows.reduce((sum, row) => sum + row.rows.reduce((subtotal, raw) => subtotal + progressBiddingAmount(raw), 0), 0);
    const expiringSoon = tempBudgetRows.reduce((sum, row) => sum + row.rows.filter((raw) => progressQuoteValidity(raw).status === "Expiring Soon").length, 0);
    const expired = tempBudgetRows.reduce((sum, row) => sum + row.rows.filter((raw) => progressQuoteValidity(raw).status === "Expired / Requote Required").length, 0);
    summaryTarget.innerHTML = summaryCardsHtml([
      { label: "Total Qty", value: totalQty, helper: `${rows.length} pivot groups from G Project`, variant: "hero" },
      { label: "Budget Done", value: `${managerProgressPercent(budgetDone, totalQty)}%`, helper: `${budgetDone}/${totalQty}` },
      { label: "PR Done", value: `${managerProgressPercent(prDone, totalQty)}%`, helper: `${prDone}/${totalQty}` },
      { label: "PO Done", value: `${managerProgressPercent(poDone, totalQty)}%`, helper: `${poDone}/${totalQty}` },
      { label: "Arrived", value: `${managerProgressPercent(arrived, totalQty)}%`, helper: `${arrived}/${totalQty}` },
      { label: "Late / At Risk", value: lateAtRisk, helper: "Late, pending, or not arrived" },
      { label: "Temp Budget Items", value: tempBudgetRows.length, helper: "Estimate vs bidding / PO tracked" },
      { label: "Estimated Amount", value: estimateAmount ? formatVnd(estimateAmount) : "-", helper: "User A estimate total" },
      { label: "Bidding Amount", value: biddingAmount ? formatVnd(biddingAmount) : "-", helper: "Interim quote comparison" },
      { label: "Quote Expiry", value: expired ? `${expired} expired` : `${expiringSoon} expiring`, helper: "14-day reminder for MFG / OM", variant: expired ? "warning" : "" },
    ]);
  }
  ...
  if (headRow) {
    headRow.innerHTML = `
      ...
      <th>PR Progress</th>
      <th>PO Progress</th>
      <th>Arrived Progress</th>
      <th>Estimate / Bidding / PO</th>
  ...
  body.innerHTML = rows.length
    ? rows.map((row) => {
      const tempRows = row.rows.filter((raw) => isProgressTempBudget(raw));
      const estimate = tempRows.reduce((sum, raw) => sum + progressEstimatedAmount(raw), 0);
      const bidding = tempRows.reduce((sum, raw) => sum + progressBiddingAmount(raw), 0);
      const poActual = tempRows.reduce((sum, raw) => sum + progressPoActualAmount(raw), 0);
      const quoteStatuses = [...new Set(tempRows.map((raw) => progressQuoteValidity(raw).status).filter(Boolean))];
      const validUntilText = [...new Set(tempRows.map((raw) => progressQuoteValidity(raw).validUntil).filter(Boolean))].slice(0, 2).join(" / ");
      return `
      <tr class="${row.lateRows || row.pendingRows || row.notArrivedRows ? "pivot-risk-row" : ""}">
        ...
        <td>${managerProgressCell(row.budgetDone, row.quantity, "Budget", managerProgressDateLine(row, "budget"))}</td>
        <td>${managerProgressCell(row.prDone, row.quantity, "PR", managerProgressDateLine(row, "pr"))}</td>
        <td>${managerProgressCell(row.poDone, row.quantity, "PO", managerProgressDateLine(row, "po"))}</td>
        <td>${managerProgressCell(row.arrived, row.quantity, "Arrived", managerProgressDateLine(row, "arrived"))}</td>
        <td>
          ${tempRows.length ? `
            <div class="reason-text"><strong>Estimate</strong> ${estimate ? formatVnd(estimate) : "-"}</div>
            <div class="reason-text"><strong>Bidding</strong> ${bidding ? formatVnd(bidding) : "Pending bidding"}</div>
            <div class="reason-text"><strong>PO</strong> ${poActual ? formatVnd(poActual) : "Pending PO"}</div>
            <div class="reason-text"><strong>Bid Var.</strong> ${estimate && bidding ? progressVarianceLabel(estimate, bidding) : "Pending bidding"}</div>
          ` : `<span class="om-cell-helper">Standard demand</span>`}
        </td>
        <td>${tempRows.length ? `<div class="pending-reason-stack">${quoteStatuses.map((status) => `<span class="status-pill ${statusClass(status)}">${status}</span>`).join("")}<small>${validUntilText || "No quote date yet"}</small></div>` : "-"}</td>
        <td>${managerDeliveryStatusCell(row)}</td>
        <td>${managerKeyDatesCell(row)}</td>
    ...
    : `<tr><td colspan="15" class="empty-cell">No G Project progress rows match the selected filters.</td></tr>`;
}
...
function managerCarryoverIsApplied(row) {
  return row?.status === "Applied" || row?.status === "User Applied";
}

function managerCarryoverStatusBucket(rows = []) {
  if (rows.some(managerCarryoverIsApplied)) return "applied";
  if (rows.some((row) => row.status === "Pending Review" || row.status === "Pending DRI")) return "pending";
...
function managerDemandCostCellImpact(row, unit, filters) {
  ...
  const originalQty = baseQty * filters.lineCount;
  ...
  const carryoverQty = appliedRows.reduce((sum, item) => sum + clampQty(item.carryoverQty), 0);
  const effectiveQty = Math.max(0, originalQty - carryoverQty);
  ...
  return {
    ...
    carryoverQty,
    effectiveQty,
    originalAmount: unitPrice ? originalQty * unitPrice : 0,
    savingAmount: unitPrice ? carryoverQty * unitPrice : 0,
    effectiveAmount: unitPrice ? effectiveQty * unitPrice : 0,
...
function managerDemandCostImpactTitle(impact) {
  ...
  return `Original Qty ${impact.originalQty} / Carryover -${impact.carryoverQty} / Effective Qty ${impact.effectiveQty} / Original Cost ${formatMoneyFromUsd(impact.originalAmount)} / Saving ${formatMoneyFromUsd(impact.savingAmount)} / Effective Cost ${formatMoneyFromUsd(impact.effectiveAmount)}${flow}`;
}
...
function renderManagerDemandCostValue(impact, viewMode, { hasPrice = true, buttonAttrs = "" } = {}) {
  ...
  const badge = impact.status === "applied"
    ...
    : impact.status === "pending"
      ? `<span class="saved-badge pending">Pending</span>`
  ...
  container.innerHTML = `
    <div class="carryover-cost-strip" aria-label="Carryover cost compare">
      <div class="carryover-cost-card">
        ...
        <small>${impact.originalQty} original qty</small>
      </div>
      <div class="carryover-cost-card saving">
        <span>Carryover Saving</span>
        <strong title="${htmlAttr(formatMoneyFromUsd(impact.savingAmount))}">-${formatCompactCurrencyFromUsd(impact.savingAmount)}</strong>
        <small>${impact.carryoverQty ? `-${impact.carryoverQty} carryover qty` : "No applied carryover"}</small>
      </div>
      <div class="carryover-cost-card effective">
        ...
        <small>${impact.effectiveQty} effective qty</small>
      </div>
      <div class="carryover-cost-card">
        <span>Saving %</span>
        <strong>${managerDemandCostSavingPercent(impact)}</strong>
        <small>${managerDemandCostScopeLabel(filters)}</small>
      </div>
    </div>`;
}
...
function renderManagerDemandCostLineCompare(filters) {
  ...
  const originalQty = appliedRows.reduce((sum, row) => sum + clampQty(row.originalQty), 0);
  const carryoverQty = appliedRows.reduce((sum, row) => sum + clampQty(row.carryoverQty), 0);
  const effectiveQty = appliedRows.reduce((sum, row) => sum + clampQty(row.effectiveQty || Math.max(0, clampQty(row.originalQty) - clampQty(row.carryoverQty))), 0);
  const savingAmount = appliedRows.reduce((sum, row) => sum + managerCarryoverCostSaving(row), 0);
  const pendingCount = rows.filter((row) => !managerCarryoverIsApplied(row) && row.status !== "Rejected").length;
  if (!rows.length) {
    container.innerHTML = `
      <div class="line-compare-empty">
        <strong>Line Carryover Compare</strong>
  ...
  container.innerHTML = `
    <section class="line-compare-strip" aria-label="Line carryover compare">
      <div class="line-compare-title">
        <strong>Line Carryover Compare</strong>
        <span>${htmlAttr(flows || "Line flow")} · ${managerDemandCostScopeLabel(filters)}</span>
      </div>
      <div class="line-compare-card">
        <span>Line Original</span>
        <strong>${originalQty || "-"}</strong>
        <small>qty before carryover</small>
      </div>
      <div class="line-compare-card saving">
        <span>Carryover from Prior Line</span>
        <strong>${carryoverQty ? `-${carryoverQty}` : "-"}</strong>
        <small>${formatCompactCurrencyFromUsd(savingAmount)} saved</small>
      </div>
      <div class="line-compare-card effective">
        <span>Line Effective</span>
        <strong>${effectiveQty || "-"}</strong>
        <small>qty after carryover</small>
      </div>
      <div class="line-compare-card pending">
        <span>Pending Review</span>
        <strong>${pendingCount || "-"}</strong>
        <small>visible, not deducted</small>
      </div>
    </section>`;
}

function managerCarryoverStatusLabel(status) {
  if (status === "User Applied") return "User Applied";
...
function managerCarryoverStatusClass(status) {
  if (status === "Applied" || status === "User Applied") return "status-pill approved";
  ...
  container.innerHTML = `
    <div class="carryover-ledger-head">
      <div>
        ...
        <p class="muted">Line-to-line traceability is always visible. Only Applied rows reduce effective cost.</p>
      </div>
    ...
    <div class="table-wrap table-shell carryover-ledger-wrap">
      <table class="data-table table-fixed workflow-table carryover-ledger-table">
        ...
        <tbody>
          ${rows.length ? rows.map((row) => `
            <tr>
              <td class="cell-identity" title="${htmlAttr(`${row.sourceLine} -> ${row.targetLine}`)}">${row.sourceLine} → ${row.targetLine}</td>
              <td class="cell-identity" title="${htmlAttr(row.item)}">${row.item}</td>
              <td class="cell-number">${STAGE_LABELS[row.phase] || row.phase}</td>
              <td class="cell-identity">${row.stationOrUnit || "-"}</td>
              <td class="cell-number">${clampQty(row.originalQty)}</td>
              <td class="cell-number">${managerCarryoverIsApplied(row) ? "-" : ""}${clampQty(row.carryoverQty)}</td>
              <td class="cell-number">${managerCarryoverIsApplied(row) ? clampQty(row.effectiveQty) : clampQty(row.originalQty)}</td>
              <td class="cell-number" title="${htmlAttr(formatMoneyFromUsd(managerCarryoverCostSaving(row)))}">${managerCarryoverIsApplied(row) ? `-${formatCompactCurrencyFromUsd(managerCarryoverCostSaving(row))}` : "-"}</td>
              <td><span class="${managerCarryoverStatusClass(row.status)}">${managerCarryoverStatusLabel(row.status)}</span></td>
              <td class="cell-identity">${row.confirmedBy || "-"}<div class="reason-text">${row.confirmedAt ? compactDateTime(row.confirmedAt) : "-"}</div></td>
              <td class="cell-note-summary" title="${htmlAttr(row.reason || "-")}"><div class="cell-spec-clamp">${row.reason || "-"}</div></td>
            </tr>`).join("") : `<tr><td colspan="11" class="empty-cell">No carryover ledger rows match this scope.</td></tr>`}
        </tbody>
      </table>
    </div>`;
}
    ...
    return `
      <tr>
        ...
        ${QUANTITY_DASHBOARD_UNITS.map((unit) => {
          ...
          return `<td class="${impact.originalQty || impact.carryoverRows.length ? managerDemandCostCellClass(impact, "demand-cost-number") : "muted-cell"}" title="${htmlAttr(managerDemandCostImpactTitle(impact))}">${renderManagerDemandCostValue(impact, filters.viewMode, { hasPrice: Boolean(row.unitPrice), buttonAttrs })}</td>`;
        }).join("")}
        <td class="${managerDemandCostCellClass(rowImpact)}" title="${htmlAttr(managerDemandCostImpactTitle(rowImpact))}">${renderManagerDemandCostValue(rowImpact, filters.viewMode, { hasPrice: Boolean(row.unitPrice) })}</td>
        <td><button class="mini return" type="button" data-manager-demand-cost-unit="${htmlAttr(row.item)}">Open Matrix</button></td>
      </tr>`;
...
function managerQuantityPriceCandidate(row) {
  ...
  if (estimatedUnitPrice > 0) return { unitPrice: estimatedUnitPrice, unitPriceUsd: estimatedUnitPrice, source: "OPM Estimate", rank: 3, date: row.submittedAt || row.createdAt || "" };
...
function managerQuantityCalcValue(group, stage, columnName) {
  ...
  if (columnName === "Actual Need QTY") {
    const carryoverQty = managerQuantityCarryoverQty(group, stage);
    if (!total && !carryoverQty) return "";
    const effectiveQty = Math.max(0, total - carryoverQty);
    return carryoverQty
      ? `<span class="quantity-saved-value" title="${htmlAttr(`Original ${total} / Carryover -${carryoverQty} / Effective ${effectiveQty}`)}">${effectiveQty}<span class="saved-badge">Saved</span></span>`
      : effectiveQty || "";
  }
  return "";
}
...
function openManagerQuantityDetail(groupKeyId) {
  ...
  document.getElementById("managerTrackSubtitle").textContent = "Phase x station matrix from User A submitted demand rows";
...
function openManagerProgressDetail(groupKeyId) {
  ...
  document.getElementById("managerDetailStatus").textContent = group.lateRows || group.pendingRows || group.notArrivedRows
    ? "Needs Attention"
    : "On Track";
  document.getElementById("managerForm").hidden = true;
  document.getElementById("managerDetail").innerHTML = `
    <section class="work-panel detail-subsection">
      ...
      <div class="item-detail-grid">
        ...
        ${detailRow("Budget Done", `${group.budgetDone}/${group.quantity}`)}
        ${detailRow("PR Done", `${group.prDone}/${group.quantity}`)}
        ${detailRow("PO Done", `${group.poDone}/${group.quantity}`)}
        ${detailRow("Arrived", `${group.arrived}/${group.quantity}`)}
          ...
          <tbody>
            ${group.rows.map((row) => `
              <tr>
                ...
                <td>${row.purpose || "-"}</td>
                <td>${managerProgressStage(row)}</td>
                <td>${row.requiredDeliveryDate || "-"}<div class="reason-text">Deadline ${row.requestDeadline || "-"}</div></td>
                <td>${budgetPackageCode(row)}<div class="reason-text">${budgetPackageHelper(row)}</div></td>
                <td>${row.prNo || "-"}<div class="reason-text">${row.prStatus || "-"}</div></td>
                <td>${row.buyerPoNo || row.poNo || "-"}<div class="reason-text">${row.poStatus || "-"}</div></td>
                <td>ETA ${row.etaPlan || row.eta || "-"}<div class="reason-text">DTA ${row.dtaActual || row.actualEta || "-"}</div></td>
  ...
  rowsTarget.innerHTML = projectConfigs.length
    ? projectConfigs.map((project) => `
      <tr>
        ...
        <td>
          <span class="status-pill ${project.openToUser ? "ready-for-handoff" : "draft"}">${project.openToUser ? "Open to User A" : "Draft"}</span>
        </td>
...
function saveProjectSetup(openToUser = false) {
  ...
  renderSourcing();
  renderBuyer();
  showToast(openToUser ? `${code} saved and opened to User A.` : `${code} saved as draft project.`, "success");
}
...
function setDeptTab(tabName) {
  const allowedTabs = new Set(["request", "needConfirmation", "submissions"]);
...
function requestFromRecord(record, overrides = {}) {
  ...
  const draft = {
    ...
    timelineSource: `${projectTypeFor(project)} OPM Timeline`,
...
function suggestionToRecord(suggestion) {
  ...
  const materialPatch = isLegacyMaintenance(suggestion)
    ? ensureMaterialMaster(suggestion, {
      createdBy: roleProfiles[currentRole]?.name || "User A",
...
function seedCoordinatorComputerData() {
  ...
  let computerRequest = requestFromRecord(computerRecord, {
    ...
    handoffSelected: false,
	    ...
	    omScopeReason: "Matched standard OM demand bucket; final model is not required from User A.",
	    omCollectionStatus: "",
...
function seedOmDemoData() {
  ...
  const demoRows = [
    requestFromRecord(validRecord, {
      ...
      quotationPdf: "quote_keyboard_valid.pdf",
    ...
    requestFromRecord(expiredRecord, {
      ...
      quotationPdf: "quote_expired_refresh.pdf",
      ...
      procurementRemark: "Reference quote returned from PAS and is waiting for User A confirmation.",
    ...
    requestFromRecord(validRecord, {
      ...
      quotationPdf: "quote_pas_result_ready.pdf",
      ...
      procurementRemark: "PAS quote is ready and can be sent to User A confirmation.",
    ...
    requestFromRecord(validRecord, {
      ...
      quotationPdf: "quote_export_ready.pdf",
      ...
      procurementRemark: "User A confirmed this quote. Use this row to test Expense/Capex selection, Export Package, and Mark Exported.",
  ...
  seedOmHistory(demoRows[0], "Uploaded quote PDF", demoRows[0].quotationPdf);
  ...
  seedOmHistory(demoRows[2], "PAS result uploaded", "Quote file, vendor, date, and price are ready to send to User A confirmation.");
  seedOmHistory(demoRows[2], "Uploaded quote Excel", demoRows[2].quotationExcel);
  seedOmHistory(demoRows[3], "User A confirmed need", "Demo row is ready for Final Export package testing.");
...
function seedManagerQuantityMatrixDemoData() {
  ...
  const demoRows = sourceRecords.map((record, index) => {
    ...
    const request = requestFromRecord(record, {
      ...
      status,
      selected: false,
      managerReason: status === "Approved" ? "Demo approved quantity for manager matrix review." : "",
...
function renderNaturalRows() {
  ...
  document.getElementById("naturalCount").textContent = naturalSearchActive
    ? `${rows.length} result${rows.length === 1 ? "" : "s"}`
    : `${rows.length} classified item${rows.length === 1 ? "" : "s"}`;
  document.getElementById("naturalRows").innerHTML = rows.length
    ? rows.map((row) => `
      <tr>
        <td class="cell-identity" title="${htmlAttr([row.name, omResponsibilityMatch(row) ? `OM: ${omCategoryCompact(applyOmResponsibility(row))}` : ""].filter(Boolean).join(" · "))}">
          <div class="identity-block">
            <span class="identity-primary">${row.name}</span>
            ${omResponsibilityMatch(row) ? `<span class="identity-secondary">OM: ${omCategoryCompact(applyOmResponsibility(row))}</span>` : ""}
          </div>
        </td>
        <td class="cell-spec-summary" title="${htmlAttr(userVisibleItemDetail(row) || "")}">
          <div class="spec-summary">${userVisibleItemDetail(row) || "-"}</div>
        </td>
        <td class="cell-status"><span class="status-pill ${statusClass(rowSourceLabel(row))}">${rowSourceLabel(row)}</span></td>
...
function compactItemMeta(row) {
  return [
    ...
    activePhaseText(row),
    isOmBuyScope(row) ? `OM ${omCategoryCompact(row)}` : "",
  ].filter(Boolean).join(" · ");
}
...
function renderRequestRows() {
  const rows = activeProjectRequests();
  document.getElementById("requestRows").innerHTML = rows.length
    ? rows.map((row) => `
      <tr data-request-row="${row.id}">
        <td class="cell-select"><label class="check"><input type="checkbox" data-select-request="${row.id}" ${row.selected ? "checked" : ""} ${!canRequesterEditRequest(row) ? "disabled" : ""} /> Select</label></td>
        <td class="cell-text">
          <div class="item-primary">${row.name}</div>
          <div class="reason-text request-compact-meta">${compactItemMeta(row)}</div>
          ${amendmentBadgeHtml(row)}
        </td>
        <td class="cell-spec"><div class="request-spec-summary cell-spec-clamp" title="${htmlAttr(userVisibleItemDetail(row) || itemDetail(row) || "")}">${userVisibleItemDetail(row) || "-"}</div></td>
        <td class="cell-date">
          <input class="compact-date-input" type="date" data-request-need-date="${row.id}" value="${needDateForRow(row)}" ${!canRequesterEditRequest(row) ? "disabled" : ""} />
          <div class="reason-text">Required before submit</div>
        </td>
        <td class="cell-number"><strong>${totalQty(row)}</strong><div class="reason-text">${activePhaseText(row)}</div></td>
        <td class="cell-number"><strong>${stationBreakdownRowsCount(row)}</strong><div class="reason-text">${stationBreakdownRowsCount(row) === 1 ? "demand row" : "demand rows"}</div></td>
        <td class="cell-status">${stationBreakdownStatusHtml(row)}</td>
        <td class="cell-status"><span class="status-pill ${statusClass(row.status)}">${row.status}</span>${row.amendmentStatus ? `<div>${amendmentBadgeHtml(row)}</div>` : ""}</td>
        <td class="cell-timeline">${draftTimelineCell(row)}</td>
        <td class="cell-action">
          <div class="row-action-stack">
            <button class="mini approve" title="Edit demand rows" data-edit-demand="${row.id}" ${!canRequesterEditRequest(row) ? "disabled" : ""}>Edit</button>
            <button class="mini reject" data-remove-request="${row.id}" ${!canRequesterEditRequest(row) ? "disabled" : ""}>Remove</button>
          </div>
        </td>
        <td class="cell-action">${itemDetailButton("request", row.id)}</td>
      </tr>`).join("")
    : `<tr><td colspan="11" class="empty-cell">No draft items yet. Open Add / Reuse Item to search catalog, reuse history, or import a project package.</td></tr>`;
}
...
function renderUserDemandOverview() {
  ...
  if (summary) {
    ...
    summary.innerHTML = summaryCardsHtml([
      ...
      { label: "Submitted Items", value: submittedCount, helper: "Visible to Manager B" },
    ]);
  }
...
function syncUserAppliedCarryoverLedger(row, breakdown) {
  const carryoverQty = clampQty(breakdown.carryoverQty);
  ...
  window.ProcurementCarryover.recordUserAppliedCarryover({
    ...
    item: row.name,
    spec: userVisibleItemDetail(row) || itemDetail(row) || "",
    phase: STAGE_LABELS[stationBreakdownPhaseKey(breakdown)] || stationBreakdownPhaseKey(breakdown),
    stationOrUnit: demandTypeFor(breakdown) === DEMAND_TYPE_MFG ? (breakdown.station || "-") : (breakdown.demandUnit || DEMAND_UNIT_FALLBACK),
    requestLine: breakdown.requestLine || "",
    carryoverFrom: breakdown.carryoverFrom || "",
    originalQty: stationBreakdownRowTotal(breakdown),
    carryoverQty,
    unitPrice: userCarryoverUnitPriceVnd(row),
    unitPriceUsd: amountUsdFromVnd(userCarryoverUnitPriceVnd(row)),
    confirmedBy: currentRequesterPersona()?.name || roleProfiles[currentRole]?.name || "User A",
    reason: breakdown.carryoverReason || "User A applied carryover from request line editor.",
  });
}
...
function renderDemandEditor() {
  ...
  const modal = document.getElementById("demandEditorModal");
  if (!row || !modal) return;
  document.getElementById("demandEditorTitle").textContent = `${row.name} / Demand Breakdown`;
  ...
  document.getElementById("demandEditorRows").innerHTML = rows.length
    ? rows.map((item) => {
      ...
      return `
        <tr class="${demandType === DEMAND_TYPE_NON_MFG ? "non-mfg-demand-row" : ""}">
          ...
          <td>
            <select ${disabled || demandType === DEMAND_TYPE_NON_MFG ? "disabled" : ""} data-demand-editor-id="${row.id}" data-demand-editor-row="${item.id}" data-demand-editor-field="station">
              ${demandType === DEMAND_TYPE_NON_MFG ? `<option value="">N/A</option>` : ""}
              ${STATION_MASTER.map((station) => `<option value="${station}" ${station === item.station ? "selected" : ""}>${station}</option>`).join("")}
            </select>
          </td>
          <td>
            <select ${disabled || demandType === DEMAND_TYPE_MFG ? "disabled" : ""} data-demand-editor-id="${row.id}" data-demand-editor-row="${item.id}" data-demand-editor-field="demandUnit">
              ${demandType === DEMAND_TYPE_MFG ? `<option value="">N/A</option>` : demandUnitOptionsHtml(item.demandUnit)}
            </select>
          </td>
          ...
          <td><input ${disabled} class="compact-input" type="number" inputmode="numeric" pattern="[0-9]*" min="0" step="1" value="${clampQty(item.carryoverQty)}" data-demand-editor-id="${row.id}" data-demand-editor-row="${item.id}" data-demand-editor-field="carryoverQty" /></td>
          <td><input ${disabled} type="text" value="${htmlAttr(item.carryoverReason || "")}" placeholder="Why carry over?" data-demand-editor-id="${row.id}" data-demand-editor-row="${item.id}" data-demand-editor-field="carryoverReason" /></td>
    ...
    : `<tr><td colspan="11" class="empty-cell">Add demand rows for phase, station or demand unit, and quantity.</td></tr>`;
}
...
function updateDemandEditorField(requestId, breakdownId, field, value) {
  requests = requests.map((row) => {
    ...
    const stationBreakdown = stationBreakdownRowsForDetail(row).map((item) => {
      ...
      updateRequestCarryover({ project: row.project, phase: next.phase, demandType: next.demandType });
      syncUserAppliedCarryoverLedger(row, next);
      return next;
    });
    return syncRowPhaseQtyFromStationBreakdown({ ...row, stationBreakdown });
  });
...
function historyPackageLabel(key) {
  ...
  return `${project || "Unknown"} / ${stageLabel(phase)} reusable package`;
}
...
function renderHistoryPackageRows() {
  ...
  if (targetContext) {
    targetContext.textContent = `Add to: ${requestCarryoverProject()} / default phase ${stageLabel(requestCarryoverPhase())}`;
  }
  ...
  `).join("") : `<tr><td colspan="6" class="empty-cell">No reusable package items match the current source filters.</td></tr>`;
}
...
function renderHistoryRows() {
  ...
  document.getElementById("historyRows").innerHTML = rows.length ? rows.map((row) => `
    <tr>
      ...
      <td class="cell-code history-material-no" title="${htmlAttr(factoryMaterialNoFor(row) || "Factory material no pending")}">${factoryMaterialNoFor(row) || "Factory material no pending"}</td>
      ...
      <td class="cell-action">${itemDetailButton("record", row.id)}</td>
    </tr>`).join("") : `<tr><td colspan="7" class="empty-cell">No reusable history records match this search.</td></tr>`;
  renderHistoryPackageRows();
}

function omUserQuoteDecisionLabel(row) {
  if (row.userAQuoteDecisionStatus) return row.userAQuoteDecisionStatus;
  ...
  return `
    <div class="amendment-queue-summary">
      ...
      <div class="amendment-queue-row meta amendment-queue-row-wide">
        <span>Flow</span>
        <strong>${row.amendmentRequestedBy || "User A"} -> ${row.amendedBy || "OM Purchasing"} -> ${row.amendmentUserConfirmedBy || "User A"}</strong>
      </div>
    </div>`;
}
...
function amendmentReferenceRows(row) {
  ...
  if (row.amendmentUserConfirmedBy) rows.push(detailRow("User A Confirmed By", row.amendmentUserConfirmedBy));
  if (row.amendmentUserConfirmedAt) rows.push(detailRow("User A Confirmed At", fullTimestamp(row.amendmentUserConfirmedAt)));
  if (row.amendmentUserRejectedBy) rows.push(detailRow("User A Rejected By", row.amendmentUserRejectedBy));
  if (row.amendmentUserRejectedAt) rows.push(detailRow("User A Rejected At", fullTimestamp(row.amendmentUserRejectedAt)));
...
function canUserAAmend(row) {
  return row
    ...
    && isOmBuyScope(row)
    && Boolean(row.quoteDate || row.quotationPdf || effectiveUnitPrice(row) || row.omStage === "userConfirm" || row.omStage === "finalExport")
...
function needConfirmationRows() {
  return requests
    .filter((row) => row.project === currentProject
      && (row.userAQuoteDecisionStatus === OM_WAITING_USER_CONFIRM || row.amendmentStatus === AMENDMENT_WAITING_USER_CONFIRM))
...
function quoteAttachmentNames(row) {
  return [row.quotationPdf, row.quotationExcel].filter(Boolean);
}

function quoteAttachmentFileHtml(label, fileName, ready) {
  return `
    <div class="quote-file-card ${ready ? "ready" : "missing"}">
      <span>${label}</span>
      <strong>${fileName || `No ${label}`}</strong>
    </div>`;
}
...
function quoteAttachmentListHtml(row) {
  return `
    <div class="quote-file-list">
      ${quoteAttachmentFileHtml("PDF", row.quotationPdf, Boolean(row.quotationPdf))}
      ${quoteAttachmentFileHtml("Excel", row.quotationExcel, Boolean(row.quotationExcel))}
    </div>`;
}

function userQuoteAttachmentStatus(row) {
  if (row.quotationPdf && row.quotationExcel) return "PDF + Excel uploaded";
  if (row.quotationPdf) return "PDF uploaded";
...
function userQuoteStageLabel(row) {
  ...
  if (row.userAQuoteDecisionStatus === USER_CANCELLED_REQUEST) return "Cancelled by User A";
...
function renderNeedConfirmationRows() {
  ...
  const oldest = rows
    .map((row) => historyTimestamp(row, "Sent to User A for confirmation") || latestRequestActivityTime(row))
  ...
  target.innerHTML = rows.length
    ? rows.map((row) => {
      const waitingAt = historyTimestamp(row, "Sent to User A for confirmation") || latestRequestActivityTime(row);
      ...
      <article class="need-confirm-card amendment-card ${overdue ? "need-confirm-overdue" : ""}">
        <div class="need-confirm-main">
          ...
          <h4>${row.name}</h4>
          <p>${row.amendmentReason || "OM Purchasing updated this request and needs your confirmation before it goes back to Manager B."}</p>
...
function timelineMilestones(row) {
  ...
  return [
    ...
    { key: "quoteReady", label: "Quote Ready", done: quoteReadyDone, pending: row.omStage === "pasResult" && !quoteReadyDone, at: row.quoteReadyAt || historyTimestamp(row, "Saved quote info") || historyTimestamp(row, "Sent to User A for confirmation") },
    { key: "userConfirm", label: row.userAQuoteDecisionStatus === USER_CANCELLED_REQUEST ? "Cancelled" : "User Confirm", done: [OM_WAITING_USER_CONFIRM, OM_USER_CONFIRMED, USER_CANCELLED_REQUEST].includes(row.userAQuoteDecisionStatus), pending: row.userAQuoteDecisionStatus === OM_WAITING_USER_CONFIRM, blocked: row.userAQuoteDecisionStatus === USER_CANCELLED_REQUEST, at: row.userAQuoteDecisionAt || historyTimestamp(row, "Sent to User A for confirmation") },
...
function submissionCurrentStatus(row) {
  const statuses = [
    row.amendmentStatus || "",
    row.status === "Submitted" ? "Submitted to Manager B" : row.status,
...
function submissionActionStatusCell(row) {
  ...
  if (row.amendmentStatus === AMENDMENT_CONFIRMED) {
    return `<span class="status-pill ${statusClass(AMENDMENT_CONFIRMED)}">${AMENDMENT_CONFIRMED}</span><div class="reason-text">Resubmitting to Manager B.</div>`;
  }
  if (row.amendmentStatus === AMENDMENT_SUBMITTED) {
    return `<span class="status-pill ${statusClass(AMENDMENT_SUBMITTED)}">${AMENDMENT_SUBMITTED}</span><div class="reason-text">Waiting Manager B approval.</div>`;
  }
...
function renderSubmissionRows() {
  ...
  document.getElementById("submissionRows").innerHTML = rows.length
    ...
    : `<tr><td colspan="8" class="empty-cell">No draft or submitted demand for ${currentProject} yet.</td></tr>`;
}
...
function managerAuditTimelineEvents(row) {
  ...
  const directEvents = [
    row.submittedAt ? {
      ...
      actor: row.submittedBy || row.requesterName || "User A",
      note: `${row.project} request submitted for manager approval.`,
      timestamp: row.submittedAt,
      source: "Request",
    } : null,
    row.decidedAt ? {
      action: row.status === "Rejected" ? "Rejected to DRI" : "Approved by Manager",
      actor: row.decidedBy || "Manager B",
      note: row.managerReason || row.rejectReason || "Manager decision recorded.",
    ...
    row.userAQuoteDecisionAt ? {
      action: row.userAQuoteDecisionStatus === USER_CANCELLED_REQUEST ? "User A cancelled request" : "User A confirmed need",
      actor: row.userAQuoteDecisionBy || "User A",
      note: row.userAQuoteCancelReason || "User A quote decision recorded.",
    ...
    row.buyerReceivedAt ? {
      ...
      note: row.buyerStatus || "Buyer downstream progress started.",
...
function addRecord(recordId) {
  ...
  if (!record) return;
  const targetProject = requestCarryoverProject();
  const targetPhase = requestCarryoverPhase(targetProject);
  ...
  const draft = requestFromRecord(record, {
    ...
    ...(isOmCatalogRow(record) ? {
      ...
      requesterReason: "Selected from source item; station breakdown quantity must be entered by User A / IE.",
    }),
  });
  requests = [draft, ...requests];
  updateRequestCarryover({ project: targetProject, phase: targetPhase, demandType: lastDemandType });
  closeItemPicker();
  renderDepartment();
  openDemandEditor(draft.id);
  showToast(`Item added to ${targetProject} / ${stageLabel(targetPhase)}. Enter demand quantity.`, "success");
}

function addHistoryRecord(recordId, useSourceQty = true) {
  const record = reusableHistoryRecordById(recordId);
  if (!record) return;
  const targetProject = requestCarryoverProject();
  const targetPhase = requestCarryoverPhase(targetProject);
  const draft = requestFromRecord(record, historyRequestOverrides(record, useSourceQty, { targetProject, targetPhase }));
  requests = [draft, ...requests];
  updateRequestCarryover({ project: targetProject, phase: targetPhase, demandType: lastDemandType });
  setDeptTab("request");
  closeItemPicker();
  renderDepartment();
  openDemandEditor(draft.id);
  showToast(`Added to ${targetProject}. Source phase and qty were copied.`, "success");
}
...
function cloneReusableDemandRows(record, { useSourceQty = true, targetProject = requestCarryoverProject(), targetPhase = requestCarryoverPhase(targetProject) } = {}) {
  if (useSourceQty && Array.isArray(record?.stationBreakdown) && record.stationBreakdown.length) {
    return record.stationBreakdown.map((item) => createStationBreakdownEntry({ ...record, ...item, project: targetProject }, {
      phase: targetPhase,
      demandType: item.demandType || demandTypeFor(item),
      station: item.station || record.station,
      demandUnit: item.demandUnit || record.demandUnit || record.department,
  ...
  if (useSourceQty) {
    ...
    const retargetedRows = rows.map((row) => createStationBreakdownEntry({ ...record, ...row, project: targetProject }, {
      phase: targetPhase,
      demandType: row.demandType || demandTypeFor(row),
      station: row.station || record.station,
      demandUnit: row.demandUnit || record.demandUnit || record.department,
      qty: stationBreakdownRowTotal(row),
      remark: row.remark || "",
    }));
    if (retargetedRows.some((row) => stationBreakdownRowTotal(row) > 0)) return retargetedRows;
  }
  return [createStationBreakdownEntry({ ...record, project: targetProject }, { phase: targetPhase, demandType: lastDemandType, qty: 0 })];
}
...
function historyRequestOverrides(record, useSourceQty = true, { targetProject = requestCarryoverProject(), targetPhase = requestCarryoverPhase(targetProject) } = {}) {
  const stageOverrides = useSourceQty
    ? {}
    : STAGES.reduce((values, stage) => ({ ...values, [stage]: 0 }), {});
  const referenceBreakdown = cloneReusableDemandRows(record, { useSourceQty, targetProject, targetPhase });
  return {
    ...stageOverrides,
    project: targetProject,
    ...
    selected: true,
    requesterReason: useSourceQty
      ? `Source quantity copied from ${record.project} approved history.`
      : `Added from ${record.project} approved history. Source quantity kept as reference only.`,
  };
}

function copyHistory(useSourceQty = true) {
  ...
  const selected = selectedRecords.map((row) => requestFromRecord(row, historyRequestOverrides(row, useSourceQty)));
  ...
  setDeptTab("request");
  showToast(useSourceQty ? "Selected history items added with source quantities." : "Selected history items added to Request with zero quantity.", "success");
}

function importHistoryPackage() {
  const sourceRows = selectedHistoryPackageRows();
  if (!sourceRows.length) {
    showToast("No reusable package items match the current source filters.", "error");
    return;
  }
  const targetProject = requestCarryoverProject();
  const targetPhase = requestCarryoverPhase(targetProject);
  const imported = sourceRows.map((row) => requestFromRecord(row, historyRequestOverrides(row, true, { targetProject, targetPhase })));
  requests = [...imported, ...requests];
  updateRequestCarryover({ project: targetProject, phase: targetPhase, demandType: lastDemandType });
  setDeptTab("request");
  closeItemPicker();
  renderDepartment();
  showToast(`Imported ${imported.length} items to ${targetProject}. Review and edit demand before submit.`, "success");
}

function submitRequests() {
  const selectedRows = requests.filter((row) => row.project === currentProject && canRequesterEditRequest(row) && row.selected);
  if (!selectedRows.length) {
    showToast("Select at least one draft request before submitting to Manager B.", "error");
    return;
  }
  if (selectedRows.some((row) => !stationBreakdownHasDemand(row))) {
    showToast("Add at least one demand row quantity before submitting to Manager B.", "error");
    return;
  }
  if (selectedRows.some((row) => !needDateForRow(row))) {
    showToast("Need Date is required for every selected draft item before submitting.", "error");
    return;
  }
  if (selectedRows.some((row) => !isMaintenanceComplete(row) && !isMaterialNoPending(row))) {
    showToast("Complete material information for selected legacy rows before submitting to Manager B.", "error");
    return;
  }
  let submitted = 0;
  const now = new Date().toISOString();
  ...
  requests = requests.map((row) => {
    if (row.project === currentProject && canRequesterEditRequest(row) && row.selected) {
      submitted += 1;
      const newId = submittedIds.get(row.id);
      const needDate = needDateForRow(row);
      return syncRowPhaseQtyFromStationBreakdown({
        ...
        needDate,
        requiredDeliveryDate: needDate,
        requiredDeliveryDateDri: needDate,
        requestDeadline: row.requestDeadline || needDate,
        ...
        ...(row.amendmentOf ? {
          ...
          amendedBy: roleProfiles[currentRole]?.name || "User A",
  ...
  amendmentSubmissions.forEach((item) => {
    ...
    if (source) addHandoffHistory(source, "Amendment submitted to Manager", item.newId);
    if (amendment) addHandoffHistory(amendment, "Amendment submitted to Manager", amendment.amendmentReason || "User A submitted amendment.");
  });
  requests
    .filter((row) => [...submittedIds.values()].includes(row.id))
    .forEach((row) => addHandoffHistory(row, "Need date submitted", needDateForRow(row)));
  ...
  renderManager();
  showToast(`${submitted} item${submitted === 1 ? "" : "s"} submitted as one package to Manager B.`, "success");
}
...
function createNewItemSuggestion() {
  const suggestion = {
    id: `NIS-${String(newItemSequence++).padStart(4, "0")}`,
    mode: "New Material",
    project: currentProject,
...
function validateNewItem(values) {
  ...
  if (!values.standardNameCn || !values.standardNameEn || !values.standardNameVn || !values.detail || !values.spec || !values.useCase) {
    showToast("Standard part name CN/EN/VN, detail, spec, and reason / use case are required.", "error");
    return false;
  }
...
function syncMaterialEntryFields(row) {
  ...
  ["standardNameCn", "standardNameEn", "standardNameVn", "detail", "spec", "estimatedUnitPrice", "estimatedAmount", "budgetRemark", "useCase"].forEach((field) => {
...
function renderMaterialEntryModal() {
  ...
  document.getElementById("materialEntryTitle").textContent = legacy ? "Complete Item Information" : "Create New Item";
  const mode = document.getElementById("materialEntryMode");
  mode.textContent = legacy ? "Legacy Item Standardization" : "New Item";
  ...
  document.getElementById("materialEntryHelper").textContent = legacy
    ...
    : "User A does not need to provide a material number. PAS / PUR will provide external material tracking later.";
...
function managerProgressPendingReason(row) {
  ...
  if (normalize(row.poStatus).includes("pending")) return "PO pending";
  if (normalize(row.prStatus).includes("pending")) return "PR pending";
  if (normalize(row.budgetStatus).includes("pending")) return "Budget pending";
  if (normalize(row.actualEta).includes("pending")) return "Arrival pending";
  return "";
}
...
function managerProgressIsPending(row) {
  return Boolean(managerProgressPendingReason(row))
    || ["budgetStatus", "prStatus", "poStatus"].some((field) => ["pending", "in progress"].some((status) => normalize(row[field]).includes(status)));
}
...
function progressQuoteValidity(row) {
  ...
  if (days <= 14) return { validUntil, receivedAt, status: "Expiring Soon", daysRemaining: days };
...
function omStageTrackingCell(group, stage) {
  ...
  const cell = {
    ...
    confirm: {
      ...
      note: rows.some((row) => row.userAQuoteDecisionStatus === OM_USER_CONFIRMED) ? "User confirmed" : rows.some((row) => isOmWaitingUserConfirm(row)) ? "Waiting User A" : "Not sent to User A",
    },
    export: {
...
function omCurrentStageForRow(row) {
  if (row.finalExportedAt || [OM_EXPORTED_CFA, OM_EXPORTED_ECS].includes(row.finalExportStatus)) return "Exported";
  if (row.userAQuoteDecisionStatus === OM_USER_CONFIRMED || row.finalExportStatus || row.finalExportTarget || row.omStage === "finalExport") return "Export Package";
  if (row.omStage === "priceReview" || row.priceDecisionStatus === PRICE_ESCALATION_REQUIRED) return "Price Review";
  if (isOmWaitingUserConfirm(row) || row.omStage === "userConfirm") return "Waiting User A";
  if (row.pasDemandNo || row.omStage === "pasResult") return "PAS Quote Result";
  return "PAS Demand No";
}
...
function omPendingOwnerForRow(row) {
  if (row.finalExportedAt || [OM_EXPORTED_CFA, OM_EXPORTED_ECS].includes(row.finalExportStatus)) return "OM Complete";
  if (row.priceDecisionStatus === PRICE_ESCALATION_REQUIRED && !row.driApprovedAt) return "Dept DRI";
  if (row.priceDecisionStatus === PRICE_ESCALATION_REQUIRED && row.driApprovedAt && !row.projectDriApprovedAt) return "Budget Approver";
  if (isOmWaitingUserConfirm(row) && !row.userAQuoteDecisionAt) return "User A";
  if (row.pasDemandNo && !isOmQuoteResultReady(row)) return "PAS / Bidding";
...
function omPendingOwnerForGroup(group) {
  const owners = [...new Set((group.rows || []).map(omPendingOwnerForRow))];
  return owners.sort((left, right) => omPendingOwnerPriority(left) - omPendingOwnerPriority(right))[0] || "OM Purchasing";
}

function omQuoteStatusForRow(row) {
  if (!row.pasDemandNo || !isOmQuoteResultReady(row)) return "Waiting PAS Reply";
  const validity = omQuoteValidity(row);
  if (validity === "Quote Expired") return "Expired / Requote Required";
  if (validity === "Quote Expiring Soon") return "Expiring Soon";
  if (validity === "Quote Valid") return "Reusable Quote";
...
function omQuoteStatusForGroup(group) {
  const statuses = [...new Set((group.rows || []).map(omQuoteStatusForRow))];
  return statuses.sort((left, right) => omQuoteStatusPriority(left) - omQuoteStatusPriority(right))[0] || "Waiting PAS Reply";
}

function omStageStartAt(row, stage = omCurrentStageForRow(row)) {
  if (stage === "Exported") return row.finalExportedAt || row.finalExportPreparedAt || omReceivedAt(row);
  if (stage === "Export Package") return row.userAQuoteDecisionAt || row.finalExportPreparedAt || row.sentToUserAAt || omReceivedAt(row);
  if (stage === "Waiting User A") return row.sentToUserAAt || historyTimestamp(row, "Sent to User A for confirmation") || row.quoteCompletionReadyAt || omReceivedAt(row);
  if (stage === "PAS Quote Result") return row.pasDemandNoRecordedAt || row.pasDemandNoUpdatedAt || omReceivedAt(row);
  return omReceivedAt(row);
}
...
function omCurrentStageForGroup(group) {
  const rows = group.rows || [];
  const activeStages = rows
    .map(omCurrentStageForRow)
    .filter((stage) => stage !== "Exported");
  if (activeStages.length) {
    return activeStages.sort((left, right) => omStagePriority(left) - omStagePriority(right))[0];
  }
  return rows.some((row) => omCurrentStageForRow(row) === "Exported") ? "Exported" : "PAS Demand No";
}
...
function omGroupStageStartAt(group, stage = omCurrentStageForGroup(group)) {
  return (group.rows || [])
    .filter((row) => omCurrentStageForRow(row) === stage || stage === "Exported")
    .map((row) => omStageStartAt(row, stage))
    .filter(Boolean)
    .sort()[0] || omGroupReceivedAt(group);
}

function omDaysInStage(group) {
  const stage = omCurrentStageForGroup(group);
  if (stage === "Exported") return null;
  return daysBetweenDates(omGroupStageStartAt(group, stage));
}
...
function omAgingCell(group) {
  ...
  if (stage === "Exported") {
    return `<span class="status-pill approved">Completed</span><div class="reason-text">${startAt ? compactDateTime(startAt) : "-"}</div>`;
  }
...
function omNextActionForGroup(group) {
  ...
  if (owner === "User A") return "Wait for User A confirmation";
  if (owner === "OM Complete") return "Handoff complete";
  const stage = omCurrentStageForGroup(group);
  ...
  if (stage === "Exported") return "No action";
  return "Review OM status";
}
...
function renderOmSubmission() {
  ...
  if (summary) {
    ...
    const waitingConfirm = rows.filter((group) => omCurrentStageForGroup(group) === "Waiting User A").length;
    ...
    summary.innerHTML = summaryCardsHtml([
      ...
      { label: "Waiting User A", value: waitingConfirm, helper: "Need confirm / cancel" },
      ...
      { label: "Expiring Soon", value: expiringSoon, helper: "Quote expires within 14d" },
    ]);
  }
  ...
  body.innerHTML = rows.length
    ? rows.map((row) => {
      const quoteDates = [...new Set(row.rows.map((raw) => omQuoteValidUntil(raw)).filter(Boolean))].slice(0, 2).join(" / ");
      const omStage = omCurrentStageForGroup(row);
      const receivedAt = omGroupReceivedAt(row);
      const pendingOwner = omPendingOwnerForGroup(row);
      const quoteStatus = omQuoteStatusForGroup(row);
      return `
      <tr class="${row.lateRows || row.pendingRows || row.notArrivedRows ? "pivot-risk-row" : ""}">
        <td>${row.project}</td>
        <td><div class="item-primary">${row.item}</div><div class="reason-text">${row.rows.length} raw row${row.rows.length === 1 ? "" : "s"}</div></td>
        <td><strong>${row.quantity}</strong></td>
        <td><strong>${receivedAt ? compactDateTime(receivedAt) : "-"}</strong><div class="reason-text">${receivedAt ? "Received by OM" : "No receive timestamp"}</div></td>
        <td><span class="status-pill ${statusClass(pendingOwner)}">${pendingOwner}</span><div class="reason-text">${pendingOwner === "Buyer" ? "Downstream only" : "Current blocker"}</div></td>
        ...
        <td><span class="status-pill ${statusClass(quoteStatus)}">${quoteStatus}</span><div class="reason-text">${quoteDates || "No valid-until date yet"}</div></td>
        <td><strong>${omNextActionForGroup(row)}</strong><div class="reason-text">${row.rows.length} source row${row.rows.length === 1 ? "" : "s"}</div></td>
        <td>${pendingReasonCell(row.pendingReasons)}</td>
        <td><button class="mini return" data-om-submission-detail="${row.keyId}">Detail</button></td>
      </tr>`;
    }).join("")
    : `<tr><td colspan="10" class="empty-cell">No OM submission rows match the selected filters.</td></tr>`;
}
    ...
    <section class="work-panel detail-subsection">
      <div class="panel-title section-head-tight">
        <div>
          ...
          <p class="panel-subcopy">OM view stops at PAS / quote / user confirmation / export. Buyer PR / PO execution remains downstream and is not shown here.</p>
        </div>
      </div>
      <div class="table-wrap stage-demand-wrap">
          ...
          <tbody>
            ${rows.map((row) => {
              ...
              <tr class="${row.id === selectedManagerRequestId ? "active-row" : ""}">
                <td>${row.id}</td>
                <td>${row.project}</td>
                <td>${row.submittedBy || row.requesterName || "User A"}</td>
                ...
                <td>${totalQty(row)}</td>
                <td><span class="status-pill ${statusClass(row.status)}">${row.status}</span>${row.amendmentStatus ? `<div>${amendmentBadgeHtml(row)}</div>` : ""}</td>
                <td><input class="manager-reject-input" type="text" value="${row.managerReason || ""}" placeholder="Reject note" data-manager-inline-reason="${row.id}" /></td>
                <td><div class="manager-decision-stack"><button class="mini approve" data-manager-row-decision="${row.id}" data-manager-row-value="Approved">Approve</button><button class="mini danger" data-manager-row-decision="${row.id}" data-manager-row-value="Rejected">Reject to DRI</button></div></td>
...
function renderItemDetail(row, sourceType) {
  ...
  const identityRows = currentRole === "requester" ? [
    ...
    ...(factoryMaterialNoFor(row) && currentRole !== "requester" ? [detailRow("Factory Material No.", factoryMaterialNoFor(row))] : []),
    ...(currentRole === "requester" ? [] : [detailRow("Legacy Material No.", materialNoFor(row) || "Not assigned")]),
  ...
  const internalOmFlowRows = currentRole === "requester" ? [] : [
    ...
    ...(isOmRole() || currentRole === "manager" ? [detailRow("Vendor", isSuggestion ? "TBD" : row.vendor || "Pending OM verification")] : []),
    ...
    ...(canShowOfficialQuote ? [
      ...
      detailRow("Quote PDF", row.quotationPdf || "No PDF"),
      detailRow("Quote Excel", row.quotationExcel || "No Excel"),
    ] : []),
    ...(isOmRole() || currentRole === "manager" ? [detailRow("Unit Price Reference", price ? money(price) : "Pending")] : []),
    ...(isOmRole() || currentRole === "manager" ? [detailRow("Remark", row.procurementRemark || "No OM remark yet.")] : []),
  ];
  const omFlowRows = [
    ...requesterQuoteRows,
    ...internalOmFlowRows,
  ...
  const pasTrackingRows = currentRole === "requester" ? [] : [
  ...
  const priceDecisionRows = currentRole === "requester" ? [] : [
    ...
    detailRow("Quote Price", row.quoteUnitPrice ? money(row.quoteUnitPrice) : row.updatedPrice ? money(quoteUnitPriceVndForDecision(row)) : "-"),
    detailRow("Variance %", priceVarianceLabel(row)),
    detailRow("Threshold %", row.priceThresholdPercent !== undefined ? `${row.priceThresholdPercent}%` : "-"),
  ...
  if (isRequest) {
    ...
    downstreamRows.push(
      ...
      detailRow("Manager Reason", row.managerReason || "No manager feedback yet."),
  ...
  const groupedDetailHtml = useGroupedDetail
    ? [
      ...
      detailSection("Flow & Downstream", downstreamRows),
    ].join("")
...
function renderManagerDetail({ readonly = false } = {}) {
  ...
  document.getElementById("managerDetailTitle").textContent = `Manager Request Detail · ${row.id}`;
  ...
  document.getElementById("managerDetail").innerHTML = `
    <section class="work-panel detail-subsection">
      ...
      ${detailSummaryGridHtml([
        ...
        ["Estimated Budget", row.estimatedAmount ? formatVnd(row.estimatedAmount) : row.estimatedUnitPrice ? `${formatVnd(row.estimatedUnitPrice)} / unit` : "-", row.budgetRemark || "OPM run-ahead estimate"],
        ...
        ["Submitted", row.submittedAt ? new Date(row.submittedAt).toLocaleString("en-US") : "-", row.submittedBy || row.requesterName || "User A"],
      ])}
    </section>
  ...
  form.hidden = readonly || row.status !== "Submitted";
  document.getElementById("managerDecision").value = row.status === "Rejected" ? row.status : "Approved";
  document.getElementById("managerReason").value = row.managerReason || "";
}
...
function approvedRoutingPatch(item) {
  ...
  const requiresPas = isPasRequired(itemWithOm);
  return {
    ...omPatch,
    omScopeStatus: scopeStatus,
    omScopeReason: scopeReason,
    nextStep: requiresPas ? "PAS Required - OM Buy Scope" : "MFG / Sourcing Review",
    procurementStatus: requiresPas ? HANDOFF_WAITING_PAS : HANDOFF_READY,
    pasStatus: requiresPas ? PAS_WAITING : PAS_NOT_REQUIRED,
    pasRequired: requiresPas,
    omStatus: requiresPas ? "" : item.omStatus,
    omCollectionStatus: requiresPas ? item.omCollectionStatus : item.omCollectionStatus,
    finalSpecStatus: requiresPas ? item.finalSpecStatus : item.finalSpecStatus,
    sentToOmAt: requiresPas ? "" : item.sentToOmAt,
  };
}

function recordApprovedRouting(row) {
  if (!row || row.status !== "Approved") return;
  if (row.omStatus === AMENDMENT_REMOVED || row.amendmentStatus === AMENDMENT_REMOVED) {
    addHandoffHistory(row, "Amendment removal approved", row.amendmentReason || "Manager approved item removal.");
    return;
  }
  if (row.procurementStatus === HANDOFF_WAITING_PAS && isPasRequired(row)) {
    addHandoffHistory(row, "Waiting PAS Review", "PAS required for IT / OM Buy scope before OM Purchasing.");
  } else if (row.procurementStatus === HANDOFF_SENT_TO_OM && isOmBuyScope(row)) {
    addOmHistory(row, "PAS Approved - Send to OM", omBuyScopeReason(row));
    addHandoffHistory(row, "PAS Approved - Send to OM", omBuyScopeReason(row));
  } else {
    addHandoffHistory(row, "Ready for MFG / Sourcing Review", omBuyScopeReason(row));
  }
}

function commitManagerDecision(requestId, decision, reason, { closeModal = false, bulk = false } = {}) {
  let routedRow = null;
  const now = new Date().toISOString();
  requests = requests.map((item) => {
    if (item.id !== requestId) return item;
    const amendmentRemoval = item.amendmentOf && totalQty(item) === 0;
    const patch = decision === "Approved"
      ? (item.amendmentOf ? amendmentRemoval ? {
          procurementStatus: "",
          pasStatus: item.pasStatus || PAS_WAITING,
          omStage: "",
          omStatus: AMENDMENT_REMOVED,
          ...
          buyerStatus: "",
          buyerReceivedAt: "",
        } : approvedRoutingPatch(item))
      : { procurementStatus: item.procurementStatus };
    routedRow = {
      ...item,
      status: decision,
      managerReason: reason || (decision === "Approved" ? "Approved by Manager B." : ""),
      ...patch,
      decidedAt: now,
      managerApprovedAt: decision === "Approved" ? now : item.managerApprovedAt,
      ...(item.amendmentOf && decision === "Approved" ? {
        amendmentStatus: AMENDMENT_APPROVED,
        amendmentApprovedBy: roleProfiles[currentRole]?.name || "Manager B",
        amendmentApprovedAt: now,
      } : {}),
    };
    return routedRow;
  });
  if (decision === "Approved" && routedRow?.amendmentOf) {
    const amendmentRemoval = totalQty(routedRow) === 0;
    requests = requests.map((item) => item.id === routedRow.amendmentOf ? {
      ...item,
      amendmentStatus: amendmentRemoval ? AMENDMENT_REMOVED : AMENDMENT_SUPERSEDED,
      supersededBy: routedRow.id,
      omSelected: false,
      procurementStatus: amendmentRemoval ? "" : item.procurementStatus,
      omStage: amendmentRemoval ? "" : item.omStage,
      omStatus: amendmentRemoval ? AMENDMENT_REMOVED : item.omStatus,
      finalExportStatus: amendmentRemoval ? "" : item.finalExportStatus,
    } : item);
    const source = requests.find((item) => item.id === routedRow.amendmentOf);
    if (source) {
      addHandoffHistory(source, amendmentRemoval ? "Original request removed by amendment" : "Original request superseded", routedRow.id);
      addOmHistory(source, amendmentRemoval ? "Original request removed by amendment" : "Original request superseded", routedRow.id);
    }
    addHandoffHistory(routedRow, amendmentRemoval ? "Removal amendment approved" : "Amendment approved", routedRow.amendmentReason || "Manager approved amended demand.");
    addOmHistory(routedRow, amendmentRemoval ? "Removal amendment approved" : "Amendment approved", routedRow.amendmentReason || "Manager approved amended demand.");
  }
  if (decision === "Rejected" && routedRow?.amendmentOf) {
    requests = requests.map((item) => item.id === routedRow.amendmentOf ? {
      ...item,
      amendmentStatus: AMENDMENT_REJECTED,
      supersededBy: "",
      omSelected: false,
    } : item);
    const source = requests.find((item) => item.id === routedRow.amendmentOf);
    if (source) {
      addHandoffHistory(source, "Amendment rejected", reason || "Manager rejected amended demand.");
      addOmHistory(source, "Amendment rejected", reason || "Manager rejected amended demand.");
    }
  }
  if (decision === "Approved") recordApprovedRouting(routedRow);
  if (closeModal) closeManagerDetail();
  renderManager();
  renderDepartment();
  if (!bulk) {
    const message = decision === "Approved"
      ? "Request approved. Track it in Approval History, Progress Dashboard, and Quantity Matrix."
      : "Request rejected to DRI.";
    showToast(message, "success");
  }
}

function saveManagerDecision(event) {
  event.preventDefault();
  const row = requests.find((item) => item.id === selectedManagerRequestId);
  if (!row) return;

  const decision = event.submitter?.dataset.managerModalDecision || document.getElementById("managerDecision").value;
  document.getElementById("managerDecision").value = decision;
  const reason = document.getElementById("managerReason").value.trim();
  ...
  if (decision === "Rejected") {
    showConfirm({
      ...
      message: "This request will become read-only for User A. The reject reason will be visible.",
      confirmLabel: "Reject",
      tone: "danger",
      onConfirm: () => commitManagerDecision(row.id, decision, reason, { closeModal: true }),
    });
    return;
  }

  commitManagerDecision(row.id, decision, reason, { closeModal: true });
}

function applyManagerRowDecision(requestId, decision) {
  const row = requests.find((item) => item.id === requestId);
  if (!row || row.status !== "Submitted") return;
  const reason = document.querySelector(`[data-manager-inline-reason="${requestId}"]`)?.value.trim() || "";
  if (decision === "Rejected" && !reason) {
    showToast("Reject reason is required.", "error");
    return;
  }
  ...
  if (decision === "Rejected") {
    showConfirm({
      ...
      confirmLabel: "Reject",
      tone: "danger",
      onConfirm: () => commitManagerDecision(requestId, decision, reason),
    });
    return;
  }

  commitManagerDecision(requestId, decision, reason);
}

function commitManagerBulkDecision(ids, decision, reason) {
  const updated = ids.filter((id) => requests.some((row) => row.id === id && row.status === "Submitted")).length;
  ids.forEach((id) => commitManagerDecision(id, decision, reason, { bulk: true }));
  managerSelections.clear();
  document.getElementById("managerBulkReason").value = "";
  renderManager();
  renderDepartment();
  showToast(`${updated} selected request${updated === 1 ? "" : "s"} ${decision.toLowerCase()}.`, "success");
}

function applyManagerBulkDecision(decision) {
  const ids = [...managerSelections];
  const reason = document.getElementById("managerBulkReason").value.trim();
  if (!ids.length) {
    showToast("Select at least one submitted request first.", "error");
    return;
  }
  if (decision === "Rejected" && !reason) {
    showToast("Reject reason is required.", "error");
  ...
  if (decision === "Rejected") {
    showConfirm({
      ...
      message: `${ids.length} selected request${ids.length === 1 ? "" : "s"} will become read-only for User A. The reject reason will be visible.`,
      confirmLabel: "Reject Selected",
      tone: "danger",
      onConfirm: () => commitManagerBulkDecision(ids, decision, reason),
    });
    return;
  }

  commitManagerBulkDecision(ids, decision, reason);
}
...
function renderManagerDashboard() {
  ...
  document.getElementById("managerDashboardSummary").innerHTML = summaryCardsHtml([
    { label: "Approved", value: rows.filter((row) => row.status === "Approved").length, helper: `${document.getElementById("managerDashboardProjectFilter")?.value || "All projects"} · decision history`, variant: "hero" },
    { label: "Rejected", value: rows.filter((row) => row.status === "Rejected").length },
    { label: "Total Qty", value: rows.reduce((sum, row) => sum + totalQty(row), 0) },
    { label: "With Reason", value: rows.filter((row) => row.managerReason).length },
  ]);
  ...
  document.getElementById("managerDashboardRows").innerHTML = rows.length
    ? rows.map((row) => `
      <tr>
        <td>${row.id}</td>
        <td>${row.project}</td>
        <td>${omItemCell(row, { stageLabel: "Approval history" })}</td>
        <td>${managerAffectedPhasesText(row)}</td>
        <td>${totalQty(row)}</td>
...
function omAssignmentForRow(row) {
  return omAssignmentMap.get(row.id) || {
    requestId: row.id,
    assignedToUserId: row.omAssigneeId || "",
    assignedToName: row.omAssigneeName || "",
    assignedByName: row.omAssignedBy || "",
...
function canOperateOmRow(row) {
  if (!isOmRole()) return false;
  if (["om", "omLeader", "admin"].includes(currentRole)) return true;
  const assignment = omAssignmentForRow(row);
  return Boolean(assignment.assignedToUserId && assignment.assignedToUserId === currentOmUserId());
}

function omRowAccessReason(row) {
  if (canOperateOmRow(row)) return "";
  const assignee = omAssigneeName(row);
  if (!assignee) return "Waiting OM Leader assignment.";
...
function omPasResultStatus(row) {
  ...
  if (omReadyForBuyer(row)) return "Ready to Send User A Confirmation";
  if (!row.pasMaterialNo) return "PAS Material No Missing";
  if (row.pasMaterialNo && row.vendor && effectiveUnitPrice(row) && row.quoteDate && row.quotationPdf && row.quotationExcel && !omQuoteValidUntil(row)) return "Quote Validity Missing";
  if (row.quotationPdf && !row.quotationExcel) return "Quote Excel Missing";
  if (row.quotationExcel && !row.quotationPdf) return "Quote PDF Missing";
  if (row.quotationPdf || row.quotationExcel || row.vendor || effectiveUnitPrice(row) || row.quoteDate || omQuoteValidUntil(row)) return "Quote Info Incomplete";
...
function omQuoteValidityHtml(row, { readOnly = false } = {}) {
  ...
  const receivedAt = omQuoteReceivedAt(row);
  const days = validUntil ? daysUntil(validUntil) : null;
  const helper = status === "Quote Pending"
    ? "Quote Valid Until is required before sending to User A."
  ...
  return `
    <div class="om-validity-card ${statusClass(status)}">
      ...
      <div class="om-validity-grid">
        <label class="om-quote-entry-field">Quote Received
          ${readOnly ? `<div class="om-quote-readonly">${receivedAt || "-"}</div>` : `<input type="date" value="${receivedAt || ""}" data-om-field="quoteReceivedAt" data-om-id="${row.id}" />`}
        </label>
  ...
  return `
    <div class="om-quote-entry ${readOnly ? "readonly" : ""}">
      ...
      <div class="om-quote-entry-grid">
        ...
        <label class="om-quote-entry-field">Vendor
          ${readOnly ? `<div class="om-quote-readonly">${row.vendor || "-"}</div>` : `<input type="text" value="${row.vendor || ""}" placeholder="Vendor" data-om-field="vendor" data-om-id="${row.id}" />`}
        </label>
        <label class="om-quote-entry-field">Vendor Part No.
          ${readOnly ? `<div class="om-quote-readonly">${row.vendorPartNo || "-"}</div>` : `<input type="text" value="${row.vendorPartNo || ""}" placeholder="Vendor part no." data-om-field="vendorPartNo" data-om-id="${row.id}" />`}
        </label>
        <label class="om-quote-entry-field">Unit Price (VND)
          ${readOnly ? `<div class="om-quote-readonly">${omUnitPriceVnd(row) ? omUnitPriceVnd(row).toLocaleString("en-US") : "-"}</div>` : `<input type="number" min="0" step="1" value="${omUnitPriceVnd(row) || ""}" placeholder="VND" data-om-field="updatedPriceVnd" data-om-id="${row.id}" />`}
        </label>
      ...
      <div class="om-quote-entry-footer">
        ...
        ${readOnly ? "" : `<div class="quote-pdf-actions">
          <label class="mini upload ${row.quotationPdf ? "uploaded" : ""}">
            ${row.quotationPdf ? "PDF Uploaded" : "Upload PDF"}
            <input type="file" accept="application/pdf" data-om-pdf="${row.id}" />
          </label>
  ...
  target.innerHTML = rows.length
    ? rows.map((row) => `
      <tr>
        ...
        <td><input type="text" value="${row.vendor || ""}" placeholder="Vendor" data-sourcing-field="vendor" data-sourcing-id="${row.id}" /></td>
        <td><input type="text" value="${row.vendorPartNo || ""}" placeholder="Vendor part no." data-sourcing-field="vendorPartNo" data-sourcing-id="${row.id}" /></td>
        ...
        <td>
          <label class="mini upload ${row.quotationPdf ? "uploaded" : ""}">
            ${row.quotationPdf ? "PDF Uploaded" : "Upload PDF"}
            <input type="file" accept="application/pdf" data-sourcing-pdf="${row.id}" />
          </label>
          <div class="reason-text ${row.quotationPdf ? "quote-file-ready" : ""}">${row.quotationPdf || "No PDF"}</div>
        </td>
...
function buyerStatusHelper(row) {
  ...
  if (status === BUYER_RECEIVED) return "Buyer can now create PR / PO and track downstream progress.";
...
function buyerExternalStatusHelper(row) {
  ...
  if (status === EXT_BLOCKED) return row.buyerBlockedReason || row.buyerNote || "Blocked downstream";
  ...
  return "No downstream update yet";
}
  ...
  target.innerHTML = rows.length
    ? rows.map((row) => `
      <tr>
        <td>${row.id}</td>
        <td>${row.project}</td>
        <td>${omItemCell(row, { stageLabel: "Buyer package", extraLines: [row.finalExportTarget ? `${row.finalExportTarget} package from OM` : "OM export package"] })}</td>
        <td>
        ...
        <td class="buyer-package-cell"><span class="status-pill ${statusClass(row.finalExportTarget || "-")}">${row.finalExportTarget || "-"}</span><div class="reason-text">${buyerPackageHelper(row)}</div></td>
        <td class="buyer-status-cell"><span class="status-pill ${statusClass(buyerStatusFor(row))}">${buyerStatusFor(row)}</span><div class="reason-text">${buyerStatusHelper(row)}</div></td>
        ...
        <td class="buyer-progress-cell"><span class="status-pill ${statusClass(externalStatusFor(row))}">${externalStatusFor(row)}</span><div class="reason-text">${buyerExternalStatusHelper(row)}</div></td>
        <td>${externalEvidenceLabel(row)}</td>
...
function externalOwnerFor(row) {
  ...
  if (status === EXT_REJECTED_DRI) return "User A / DRI";
  if (status === "-") return "-";
  return "OM Purchasing";
}
...
function quoteUnitPriceVndForDecision(row) {
  const directUsd = Number(row.updatedPriceUsd || row.quoteUnitPriceUsd || 0);
  if (directUsd > 0) return Math.round(amountVndFromUsd(directUsd));
  const directVnd = Number(row.updatedPriceVnd || row.quoteUnitPriceVnd || 0);
  if (directVnd > 0) return directVnd;
  const raw = Number(String(row.updatedPrice ?? "").replace(/,/g, ""));
  if (!Number.isFinite(raw) || raw <= 0) return 0;
  return raw > 1000 ? raw : Math.round(raw * currentUsdToVndRate());
}

function historyUnitPriceVndForDecision(row) {
  ...
  if (Number.isFinite(raw) && raw > 0) return raw > 1000 ? raw : Math.round(raw * currentUsdToVndRate());
  ...
  return candidate.price > 1000 ? candidate.price : Math.round(candidate.price * currentUsdToVndRate());
}
...
function priceDecisionForRow(row) {
  ...
  const comparison = mod.compareQuoteToHistory?.({
    category,
    quoteUnitPrice: quoteUnitPriceVndForDecision(row),
    historyUnitPrice: historyUnitPriceVndForDecision(row),
...
function priceDecisionPatch(row, now = new Date().toISOString()) {
  ...
  const basePatch = {
    ...
    priceThresholdPercent: decision.thresholdPercent || 0,
...
function omReadyForBuyer(row) {
  return Boolean(row.pasMaterialNo && row.quotationPdf && row.quotationExcel && row.vendor && effectiveUnitPrice(row) && row.quoteDate && omQuoteValidUntil(row));
}
...
function omWarnings(row) {
  ...
  if (!row.vendor) warnings.push("Missing vendor");
  if (!row.quoteDate) warnings.push("Missing quote date");
  if (!omQuoteValidUntil(row)) warnings.push("Missing quote validity");
  if (!row.quotationPdf && status !== "Quote PDF Missing") warnings.push("Missing quote PDF");
...
function omHasRequiredQuoteFiles(row) {
  return Boolean(row.quotationPdf && row.quotationExcel);
}

function validateOmFinalExportAttachments(rows) {
  const missing = rows.filter((row) => !omHasRequiredQuoteFiles(row));
  if (!missing.length) return "";
  return `Upload both quote PDF and quote Excel before Export Package. Missing file rows: ${missing.map((row) => row.id).join(", ")}.`;
}
...
function renderOmSummary(rows) {
  ...
  const quoteIncompleteRows = pasRows.filter((row) => ["Quote Info Incomplete", "Quote PDF Missing", "Quote Excel Missing", "Quote Validity Missing", "Quote Completion Needed"].includes(omPasResultStatus(row)));
  const readyRows = pasRows.filter((row) => omPasResultStatus(row) === "Ready to Send User A Confirmation");
  ...
  const cards = [
    ...
    ["Ready for User A", readyRows.length],
...
function renderOmPurchasing() {
  ...
  if (quoteHint) {
    quoteHint.textContent = "Input PAS quote / bidding result, including Quote Valid Until, then send the row to User A.";
  }
  renderOmSubmission();
  renderOmPasRequest();
...
function omQuoteExpiryAction(row) {
  ...
  if (status === "Quote Expired") return "Requote required before next purchasing step.";
  if (status === "Quote Expiring Soon") return "Watch before export; prepare requote if timeline slips.";
...
function renderOmFinalExport() {
  ...
  if (exportHint) {
    exportHint.textContent = "Choose Expense or Capex, then use one Export Package action to prepare Excel and quote PDF.";
  }
  target.innerHTML = rows.length
    ? rows.map((row) => `
      <tr>
        ...
        <td class="cell-action om-export-actions-cell">
          <div class="row-action-stack">
            ...
            <button class="mini" type="button" title="Export Excel package and quote PDF package" data-om-row-button="${row.id}" data-om-row-button-action="exportPackage" ${omActionDisabledAttr(row, !(isOmFinalExportPrepared(row) || isOmFinalExported(row)))}>Export</button>
    ...
    : `<tr><td colspan="15" class="empty-cell">No User A confirmed rows are ready for export package.</td></tr>`;
}
  ...
  return `
    <div class="om-amendment-editor">
      ...
      <div class="om-amendment-section om-amendment-reference">
        ...
        ${row.amendmentReworkReason ? `<div class="reason-text">User A rework note: ${row.amendmentReworkReason}</div>` : ""}
      </div>
    </div>`;
}
...
function renderOmQuoteConfirmRows(rows) {
  ...
  if (!target) return;
  if (!rows.length) {
    target.innerHTML = `<tr><td colspan="9" class="empty-cell">No quote or user confirmation rows are available for this project package.</td></tr>`;
    return;
  }
  ...
  const sectionRow = (label, helper) => `
    <tr class="om-quote-section-row">
      <td colspan="9"><strong>${label}</strong><span>${helper}</span></td>
    </tr>`;
  const quoteRowHtml = (row) => {
      ...
      const readyToSend = status === "Ready to Send User A Confirmation";
      ...
      const userDecisionCell = amendmentWaitingUser
        ? `<span class="status-pill ${statusClass(AMENDMENT_WAITING_USER_CONFIRM)}">${AMENDMENT_WAITING_USER_CONFIRM}</span><div class="reason-text">Visible to User A for revised request confirmation.</div>`
        : waitingUserConfirm
          ...
          : amendmentAwaitingOm
            ? `<span class="status-pill ${statusClass(row.amendmentStatus)}">${row.amendmentStatus}</span><div class="reason-text">${row.amendmentReason || "Update the request, then send the revised result back to User A."}</div>`
        : `<span class="om-cell-helper">Not sent yet</span>`;
      const statusHelper = amendmentWaitingUser
        ? "Visible to User A. Waiting for revised request confirmation."
        : waitingUserConfirm
        ? "Visible to User A. Waiting for Confirm Need or Cancel Request."
        : amendmentAwaitingOm
          ? "User A requested a change. Update item/spec/qty here, then send the revised result."
        : readyToSend
          ...
          : status === "Quote Excel Missing"
            ...
            : status === "Quote PDF Missing"
              ? "Upload the quote PDF file to complete the quote package."
        : quoteCompletionNeeded
            ? "Complete PAS Material No, vendor, price, quote date, PDF, and Excel."
      ...
      <tr class="${rowClasses}">
        <td>${row.project}</td>
        <td>${currentPhaseLabelForProject(row.project)}</td>
        <td>${omItemCell(row, { stageLabel, extraLines: [`Qty ${omCurrentPrQty(row)}`, ...(row.procurementRemark ? [row.procurementRemark] : [])] })}${omAmendmentEditorHtml(row)}</td>
        <td>${omPasBundleHtml(row, { editableDemandNo: false, editableMaterialNo: false })}</td>
        <td>${omQuoteEntryHtml(row, { readOnly: waitingUserConfirm || !canOperateOmRow(row) })}</td>
        <td>${omAssignmentCell(row)}</td>
        <td>
          <div class="om-status-stack">
            <span class="status-pill ${statusClass(amendmentAwaitingOm ? OM_QUOTE_REVIEW_REQUIRED : status)}">${amendmentAwaitingOm ? OM_QUOTE_REVIEW_REQUIRED : status}</span>
            ${waitingUserConfirm ? `<span class="status-pill visible-to-user">Visible to User A</span>` : ""}
            <div class="om-status-helper">${statusHelper}</div>
            <div class="om-status-helper">${userDecisionCell}</div>
            ${warnings.length ? `<div class="om-status-tags">${warnings.map((warning) => `<span class="om-warning-chip">${warning}</span>`).join("")}</div>` : ""}
          </div>
        </td>
        <td>
          <div class="row-action-stack">
            <button class="mini" type="button" data-om-row-button="${row.id}" data-om-row-button-action="saveQuoteInfo" ${omActionDisabledAttr(row, waitingUserConfirm)}>Save Quote Info</button>
            <button class="mini approve" type="button" data-om-row-button="${row.id}" data-om-row-button-action="sendToUserConfirm" ${omActionDisabledAttr(row, !(readyToSend && !waitingUserConfirm))}>Send to User A</button>
            <button class="mini danger" type="button" data-om-row-button="${row.id}" data-om-row-button-action="rejectToDri" ${omActionDisabledAttr(row)}>Reject to DRI</button>
            <button class="mini return" type="button" data-contact-dri="${row.id}">Contact DRI</button>
          </div>
        </td>
        <td>${itemDetailButton("request", row.id)}</td>
      </tr>`;
  ...
  target.innerHTML = [
    editingRows.length ? sectionRow("Quote Editing", "Input PAS quote / bidding result, quote validity, and attachments here.") : "",
    ...
    ? rows.map((row) => `
      <tr>
        ...
        <td>
          ...
          <div class="reason-text">${row.quotationPdf || "No PDF"}</div>
        </td>
        <td>
  ...
  target.innerHTML = rows.length
    ? rows.map((row) => `
      <tr>
        ...
        <td>${row.quotePdfExportedAt ? new Date(row.quotePdfExportedAt).toLocaleString("en-US") : row.quotationPdf || "No PDF"}</td>
        <td>${itemDetailButton("request", row.id)}</td>
      </tr>`).join("")
...
function askUserAAmendSelected() {
  showToast("Amendment requests now start from User A after quote. Use the User A Request Change action instead.", "info");
}
...
function saveOmQuoteInfoRows(rows) {
  ...
  rows.forEach((row) => {
    ...
    if (latest.priceDecisionStatus === PRICE_AUTO_CLEARED) {
      ...
      addHandoffHistory(latest, "Auto cleared by threshold", latest.priceDecisionReason || "User A confirmation not required.");
    }
    ...
    addHandoffHistory(latest, "Quote compared with history", `History ${money(latest.historyUnitPrice || 0)} / Quote ${money(latest.quoteUnitPrice || 0)} / Threshold ${latest.priceThresholdPercent || 0}%`);
  });
}
...
function sendOmPasRowsToUserConfirm(rows) {
  ...
  const incomplete = rows.filter((row) => !omReadyForBuyer(row));
  if (incomplete.length) {
    showToast("Complete PAS Material No, vendor, quote date, unit price, quote PDF, quote Excel, and Quote Valid Until before sending to User A.", "error");
    return;
  }
  const now = new Date().toISOString();
  const standardRows = rows.filter((row) => !row.amendmentOf);
  if (standardRows.length) {
    saveOmQuoteInfoRows(standardRows);
    const latestRows = standardRows.map((row) => requests.find((item) => item.id === row.id) || row);
    renderOmPurchasing();
    renderDepartment();
    const autoCount = latestRows.filter((row) => row.priceDecisionStatus === PRICE_AUTO_CLEARED).length;
    const escalationCount = latestRows.filter((row) => row.priceDecisionStatus === PRICE_ESCALATION_REQUIRED).length;
    showToast(`${autoCount} auto-cleared; ${escalationCount} sent to DRI price review.`, "success");
    return;
  }
  requests = requests.map((row) => {
    if (!rows.some((selected) => selected.id === row.id)) return row;
  ...
  renderOmPurchasing();
  renderDepartment();
  showToast(`${rows.length} row${rows.length === 1 ? "" : "s"} sent to User A confirmation.`, "success");
}
...
function confirmUserAOmQuote(requestId) {
  ...
  requests = requests.map((item) => item.id === requestId ? {
    ...
    userAQuoteDecisionBy: roleProfiles[currentRole]?.name || "User A",
    userAQuoteCancelReason: "",
  } : item);
  const after = requests.find((item) => item.id === requestId);
  addOmHistory(after, "User A confirmed need", "Quoted amount confirmed by User A.");
  addHandoffHistory(after, "User A confirmed need", "Quoted amount confirmed by User A.");
  renderDepartment();
  renderOmPurchasing();
  showToast("OM quote confirmed. Row moved to Export Package.", "success");
}
...
function cancelUserAOmQuote(requestId) {
  ...
  const after = requests.find((item) => item.id === requestId);
  addOmHistory(after, "User A cancelled request", reason.trim());
  addHandoffHistory(after, "User A cancelled request", reason.trim());
  renderDepartment();
  renderOmPurchasing();
  showToast("OM buy request cancelled by User A.", "success");
}
...
function createUserAAmendmentDraft(requestId) {
  ...
  const amendmentDraft = {
    ...
    amendmentRequestedBy: roleProfiles[currentRole]?.name || "User A",
  ...
  addHandoffHistory(source, "User A requested change", reason.trim());
  addOmHistory(source, "User A requested change", reason.trim());
  renderDepartment();
  renderOmPurchasing();
...
function confirmUserAAmendment(requestId) {
  ...
  requests = requests.map((item) => {
    if (item.id === requestId) {
      return {
        ...
        status: "Submitted",
        submittedAt: now,
        submittedBy: roleProfiles[currentRole]?.name || "User A",
        managerReason: "",
        amendmentStatus: AMENDMENT_SUBMITTED,
        amendmentSubmittedAt: now,
        amendmentUserConfirmedBy: roleProfiles[currentRole]?.name || "User A",
  ...
  const after = requests.find((item) => item.id === requestId);
  addOmHistory(after, "User A confirmed revised request", row.amendmentReason || "Revised request confirmed by User A.");
  addHandoffHistory(after, "Resubmitted to Manager", row.amendmentReason || "Revised request confirmed by User A.");
  renderDepartment();
  renderManager();
  renderOmPurchasing();
  showToast("Revised request confirmed and resubmitted to Manager B.", "success");
}
...
function rejectUserAAmendment(requestId) {
  ...
  requests = requests.map((item) => {
    if (item.id === requestId) {
      return {
        ...
        amendmentUserRejectedBy: roleProfiles[currentRole]?.name || "User A",
  ...
  const after = requests.find((item) => item.id === requestId);
  addOmHistory(after, "User A rejected amendment", reason.trim());
  addHandoffHistory(after, "User A rejected amendment", reason.trim());
  renderDepartment();
  renderOmPurchasing();
...
function updateFinalExportTarget(rows, target) {
  ...
  if (invalidRows.length) {
    showToast("Only User A confirmed or price-cleared rows can be prepared for CFA or ECS.", "error");
    return;
  }
...
function priceReviewRequiresBudgetApprover(row) {
  return isTemporaryBudgetRequest(row);
}
...
function priceReviewHistoryRows() {
  return requests.filter((row) => row.priceDecisionStatus || row.driApprovedAt || row.projectDriApprovedAt || row.priceEscalationRejectedAt)
    .sort((left, right) => latestRequestActivityTime(right) - latestRequestActivityTime(left));
}

function priceVarianceLabel(row) {
  if (row.priceVariancePercent === null || row.priceVariancePercent === undefined || Number.isNaN(Number(row.priceVariancePercent))) return "-";
  return `${Number(row.priceVariancePercent).toFixed(1)}% / threshold ${row.priceThresholdPercent || 0}%`;
}
  ...
  if (pendingBody) {
    pendingBody.innerHTML = pending.length ? pending.map((row) => `
      <tr>
        ...
        <td><span class="status-pill">${row.priceThresholdCategory || "Need Classification"}</span></td>
        <td>${row.historyUnitPrice ? money(row.historyUnitPrice) : "No history"}</td>
        <td>${row.quoteUnitPrice ? money(row.quoteUnitPrice) : "-"}</td>
        <td>${priceVarianceLabel(row)}</td>
  ...
  if (historyBody) {
    ...
    historyBody.innerHTML = rows.length ? rows.map((row) => `
      <tr>
        ...
        <td><span class="status-pill ${statusClass(row.priceApprovalStatus || row.priceDecisionStatus)}">${row.priceApprovalStatus || row.priceDecisionStatus || "-"}</span></td>
        <td>${row.driApprovedAt ? `${row.driApprovedBy || "Dept DRI"}<div class="reason-text">${compactDateTime(row.driApprovedAt)}</div>` : "-"}</td>
        ...
        <td>${row.priceEscalationRejectReason || row.priceDecisionReason || "-"}</td>
        <td>${itemDetailButton("request", row.id)}</td>
...
function applyPriceReviewDecision(requestId, action) {
  ...
  if (action === "reject") {
    ...
    renderPriceReview();
    renderOmPurchasing();
    showToast("Price escalation rejected.", "success");
    return;
  }
  if (currentRole === "dri" || (!row.driApprovedAt && currentRole === "admin")) {
    if (!priceReviewRequiresBudgetApprover(row)) {
      requests = requests.map((item) => item.id === requestId ? {
        ...item,
        driApprovedAt: now,
        driApprovedBy: actor,
        ...
        userAQuoteDecisionStatus: USER_CONFIRMATION_NOT_REQUIRED,
        userAQuoteDecisionAt: now,
        userAQuoteDecisionBy: "Dept DRI approval",
      } : item);
      const latest = requests.find((item) => item.id === requestId);
      addHandoffHistory(latest, "Dept DRI approved", "Requester requirement approved; row moved to OM Leader Export Package queue.");
      addOmHistory(latest, "Dept DRI approved", "Requester requirement approved; row moved to OM Leader Export Package queue.");
      renderPriceReview();
      renderOmPurchasing();
      showToast("Dept DRI approved. Row moved to OM Leader Export Package queue.", "success");
      return;
    }
    requests = requests.map((item) => item.id === requestId ? {
      ...item,
...
function renderAdminSetup() {
  const computer = document.getElementById("adminComputerThreshold");
  const mfg = document.getElementById("adminMfgThreshold");
  const chain = document.getElementById("adminApprovalChain");
  const updated = document.getElementById("adminSetupUpdatedAt");
  if (computer) computer.value = adminApprovalSetup.thresholds.Computer;
  if (mfg) mfg.value = adminApprovalSetup.thresholds.MFG;
...
function saveAdminApprovalSetup() {
  adminApprovalSetup = {
    ...adminApprovalSetup,
    thresholds: {
      Computer: Number(document.getElementById("adminComputerThreshold")?.value || 20),
      MFG: Number(document.getElementById("adminMfgThreshold")?.value || 10),
    },
...
function commitExternalResult(rows, payload) {
  ...
  requests = requests.map((row) => {
    ...
    const rejectedToDri = payload.status === EXT_REJECTED_DRI;
      ...
      externalRejectOwner: rejectedToDri ? "User A / DRI" : row.externalRejectOwner || "",
...
function exportOmQuotePdfRows(rows) {
  if (!rows.length) {
    showToast("Select at least one final export row before exporting PDF.", "error");
    return;
  }
  if (!rows.every((row) => ensureOmRowAccess(row, "export quote PDF"))) return;
  const projects = selectedOmProjectPackage(rows);
  if (projects.length !== 1) {
    showToast("Export one final export package at a time. Please filter or select rows from a single project.", "error");
    return;
  ...
  const packageCode = omPackageCodeForRows(rows);
  const content = [
    "OM Purchasing Quote PDF Package",
    `Project Package: ${packageCode}`,
    `Generated: ${new Date().toLocaleString("en-US")}`,
    "",
    ...rows.map((row) => `${row.id} | ${row.project} | ${row.name} | ${omQuoteValidity(row)} | ${row.quotationPdf || "No uploaded PDF"}`),
  ].join("\n");
  downloadFile(`${packageCode}-OM-Quote-PDF-Package.pdf`, content, "application/pdf");
  const now = new Date().toISOString();
  rows.forEach((row) => addOmHistory(row, "Prepared export PDF", row.quotationPdf || `Exported ${packageCode} prototype quote PDF package.`));
  requests = requests.map((row) => rows.some((selected) => selected.id === row.id) ? {
    ...row,
  ...
  renderOmPurchasing();
  showToast("Final export PDF prepared.", "success");
}
...
function exportOmPackageRows(rows) {
  ...
  showToast("Export Package prepared: Excel package and quote PDF package are ready.", "success");
}
...
document.getElementById("loginForm").addEventListener("submit", async (event) => {
  event.preventDefault();
  const identifier = document.getElementById("loginAccountInput")?.value || document.getElementById("loginEmailInput")?.value || document.querySelector('#loginForm input[type="text"]')?.value || document.querySelector('#loginForm input[type="email"]')?.value || "";
  const password = document.querySelector('#loginForm input[type="password"]')?.value || "";
  try {
    if (apiModeEnabled()) {
      const user = await loginWithApi(identifier, password);
      setScreen("workspace");
      applyRole(user.role);
...
document.getElementById("managerForm").addEventListener("submit", saveManagerDecision);
...
function closeModalById(modalId) {
  const closeById = {
    ...
    itemPickerModal: closeItemPicker,
  }[modalId];
...
document.addEventListener("click", (event) => {
  ...
  const managerRowDecisionButton = event.target.closest("[data-manager-row-decision]");
  ...
  if (reuseModeTab) {
    currentReuseMode = reuseModeTab.dataset.reuseModeTab || "item";
    renderHistoryRows();
  }
  ...
  if (action === "useHistorySourceQty") copyHistory(true);
  ...
  if (action === "approveManagerSelected") applyManagerBulkDecision("Approved");
  if (action === "rejectManagerSelected") applyManagerBulkDecision("Rejected");
  ...
  if (managerRowDecisionButton) applyManagerRowDecision(managerRowDecisionButton.dataset.managerRowDecision, managerRowDecisionButton.dataset.managerRowValue);
...
document.addEventListener("change", (event) => {
  ...
  if (["omDemandProjectFilter", "omProjectFilter", "omUserConfirmProjectFilter", "omFinalExportProjectFilter", "omHistoryProjectFilter", "omOwnerFilter"].includes(event.target.id)) renderOmPurchasing();
  ...
  if (event.target.id === "managerSelectAll") {
    const submittedRows = managerRows().filter((row) => row.status === "Submitted");
    submittedRows.forEach((row) => {
      if (event.target.checked) managerSelections.add(row.id);
      else managerSelections.delete(row.id);
    });
    renderManager();
  }
  ...
  if (sourcingPdfId) {
    const fileName = event.target.files?.[0]?.name || "quotation.pdf";
    requests = requests.map((row) => row.id === sourcingPdfId ? { ...row, quotationPdf: fileName, rfqStatus: row.rfqStatus || "Quote Received" } : row);
    ...
    if (row && hasSourcingQuoteSuccess(row) && !isMaterialNoPending(row)) {
      ...
      addDispatchHistory(row, "Vendor mapping updated", `${row.materialNo} vendor quote PDF saved after sourcing upload.`);
    }
    addDispatchHistory(row, "Sourcing uploaded quote PDF", fileName);
    renderSourcing();
    renderRfqFollowUp();
    showToast("Sourcing quote PDF uploaded.", "success");
  }
  ...
  const managerBulkId = event.target.dataset.managerBulkSelect;
  if (managerBulkId) {
    if (event.target.checked) managerSelections.add(managerBulkId);
    else managerSelections.delete(managerBulkId);
    renderManager();
  }
  ...
  const omPdfId = event.target.dataset.omPdf;
  if (omPdfId) {
    const accessRow = requests.find((item) => item.id === omPdfId);
    if (!accessRow || !ensureOmRowAccess(accessRow, "upload quote PDF")) {
      event.target.value = "";
      return;
    }
    const fileName = event.target.files?.[0]?.name || "quotation.pdf";
    requests = requests.map((row) => row.id === omPdfId ? { ...row, quotationPdf: fileName } : row);
    const row = requests.find((item) => item.id === omPdfId);
    addOmHistory(row, "Uploaded quote PDF", fileName);
    renderOmPurchasing();
    showToast("Quote PDF uploaded.", "success");
  }
  ...
  if (omExcelId) {
    ...
    const fileName = event.target.files?.[0]?.name || "quotation.xlsx";
    requests = requests.map((row) => row.id === omExcelId ? { ...row, quotationExcel: fileName } : row);
...
(() => {
  ...
  const TEMP_BUDGET_REQUEST_TYPE = "Temporary Budget Request";
  const QUOTE_EXPIRY_WARNING_DAYS = 14;

  function tbText(value) {
    return String(value || "").trim();
  }

  function tbActiveViewName() {
    return tbText(globalThis.currentView || document.querySelector(".view.active")?.dataset.view);
  }

  function tbActiveView(name) {
    return document.querySelector(`[data-view="${name}"].active`);
  }

  function tbCleanupForbiddenNodes() {
    const viewName = tbActiveViewName();
    const role = tbText(globalThis.currentUserRole);
  ...
  window.cleanupTemporaryBudgetLeakage = tbCleanupForbiddenNodes;

  function tbNumber(value) {
  ...
  function tbMoney(value) {
    if (typeof formatCurrency === "function") {
      try {
        return formatCurrency(value);
      } catch (error) {}
    }
    return `${tbNumber(value).toLocaleString("en-US")} VND`;
  }
  ...
  function tbSaveStore(store) {
    try {
      localStorage.setItem(TEMP_BUDGET_STORAGE_KEY, JSON.stringify(store));
    } catch (error) {}
  }

  function tbRecordId(record) {
    return tbText(record?.requestId || record?.id || record?.requestID) || [tbText(record?.project), tbText(record?.itemName || record?.item), tbText(record?.detailSpec || record?.detail || record?.spec)].filter(Boolean).join("::");
  }

  function tbAllRecords() {
    return Array.isArray(globalThis.purchaseRecords) ? globalThis.purchaseRecords : [];
  }

  function tbHydrate() {
    const store = tbStore();
    tbAllRecords().forEach((record) => {
      const key = tbRecordId(record);
      if (!key || !store[key]) return;
      Object.assign(record, store[key]);
      record.tempBudgetMeta = { ...(record.tempBudgetMeta || {}), ...store[key] };
    });
  }

  function tbPersist(record, patch) {
    const key = tbRecordId(record);
    if (!key) return;
    const store = tbStore();
    ...
    record.tempBudgetMeta = { ...(record.tempBudgetMeta || {}), ...(patch || {}) };
  }

  function isTempBudget(record) {
    return tbText(record?.requestType || record?.tempBudgetMeta?.requestType) === TEMP_BUDGET_REQUEST_TYPE;
  }

  function totalQty(record) {
    const direct = tbNumber(record?.totalQty || record?.qty || record?.quantity);
    if (direct > 0) return direct;
    const stages = Array.isArray(globalThis.STAGES) ? globalThis.STAGES : ["p10", "p11", "evt", "dvt", "pvt", "mp"];
    return stages.reduce((sum, stage) => sum + tbNumber(record?.[stage]), 0);
  }

  function biddingAmount(record) {
    return tbNumber(record?.biddingAmount || record?.updatedPrice || record?.quoteAmount || record?.unitPrice);
  }

  function poAmount(record) {
    const direct = [
    ...
    ].map(tbNumber).find((value) => value > 0);
    if (direct) return direct;
    const unitPrice = tbNumber(record?.actualUnitPrice || record?.poActualUnitPrice || record?.buyerPoUnitPrice);
    return unitPrice > 0 && totalQty(record) > 0 ? unitPrice * totalQty(record) : 0;
  }

  function varianceView(record) {
    const estimate = tbNumber(record?.estimatedAmount);
    const bidding = biddingAmount(record);
    const po = poAmount(record);
    return {
      estimate,
      bidding,
      po,
      biddingVarianceAmount: estimate > 0 && bidding > 0 ? bidding - estimate : 0,
      biddingVariancePercent: estimate > 0 && bidding > 0 ? (bidding - estimate) / estimate : null,
      poVarianceAmount: estimate > 0 && po > 0 ? po - estimate : 0,
      poVariancePercent: estimate > 0 && po > 0 ? (po - estimate) / estimate : null
    };
  }

  function quoteValidity(record) {
    const validUntil = tbText(record?.quoteValidUntil || record?.tempBudgetMeta?.quoteValidUntil);
    const receivedAt = tbText(record?.quoteReceivedAt || record?.quoteDate || record?.tempBudgetMeta?.quoteReceivedAt);
    if (!validUntil) {
      return { validUntil: "", receivedAt, status: "Missing validity", daysRemaining: null };
    }
    ...
    if (diff < 0) return { validUntil, receivedAt, status: "Expired / Requote Required", daysRemaining: diff };
    if (diff <= QUOTE_EXPIRY_WARNING_DAYS) return { validUntil, receivedAt, status: "Expiring Soon", daysRemaining: diff };
    return { validUntil, receivedAt, status: tbText(record?.quoteStatus) || "Valid", daysRemaining: diff };
  }

  function removeSourceUrlField() {
    document.querySelectorAll("label").forEach((label) => {
      if (/Source URL/i.test(tbText(label.textContent))) {
        label.style.display = "none";
      }
    });
  }

  function tempBudgetOmValidityCard(record) {
    const variance = varianceView(record);
    const validity = quoteValidity(record);
    const key = tbRecordId(record);
    return `
      <div class="tb-validity-card">
        <div class="tb-validity-card__title">Quote Validity</div>
        <div class="tb-validity-card__grid">
          <div><span>Estimate</span><strong>${variance.estimate ? tbMoney(variance.estimate) : "Pending"}</strong></div>
          <div><span>Bidding</span><strong>${variance.bidding ? tbMoney(variance.bidding) : "Pending bidding"}</strong></div>
          <div><span>Bidding Variance</span><strong>${variance.bidding ? `${variance.biddingVarianceAmount >= 0 ? "+" : ""}${tbMoney(variance.biddingVarianceAmount)}${variance.biddingVariancePercent !== null ? ` (${(variance.biddingVariancePercent * 100).toFixed(1)}%)` : ""}` : "Pending bidding"}</strong></div>
          <label><span>Quote Received</span><input class="tb-validity-input" data-tb-key="${tbEscape(key)}" data-tb-field="quoteReceivedAt" type="date" value="${tbEscape(validity.receivedAt)}"></label>
          <label><span>Valid Until</span><input class="tb-validity-input" data-tb-key="${tbEscape(key)}" data-tb-field="quoteValidUntil" type="date" value="${tbEscape(validity.validUntil)}"></label>
          <div><span>Expiry Status</span><strong>${tbEscape(validity.status)}</strong></div>
        </div>
      </div>
    `;
  }

  function tempBudgetManagerSummary(records) {
    const summary = records.reduce((acc, record) => {
      const variance = varianceView(record);
      const validity = quoteValidity(record);
      acc.items += 1;
      acc.estimate += variance.estimate;
      acc.bidding += variance.bidding;
      acc.po += variance.po;
      if (validity.status === "Expiring Soon") acc.expiringSoon += 1;
      if (validity.status === "Expired / Requote Required") acc.expired += 1;
      return acc;
    }, { items: 0, estimate: 0, bidding: 0, po: 0, expiringSoon: 0, expired: 0 });
    return `
      <div class="tb-manager-extra">
        <article class="summary-card"><h3>Bidding Amount</h3><strong>${tbMoney(summary.bidding)}</strong><span>Interim quote comparison</span></article>
        <article class="summary-card"><h3>PO Actual</h3><strong>${tbMoney(summary.po)}</strong><span>Final actual source</span></article>
        <article class="summary-card"><h3>Expiring Soon</h3><strong>${summary.expiringSoon}</strong><span>Within ${QUOTE_EXPIRY_WARNING_DAYS} days</span></article>
        <article class="summary-card"><h3>Expired</h3><strong>${summary.expired}</strong><span>Requote required</span></article>
      </div>
    `;
  }

  function procurementExpirySummary(records) {
    const expiring = records.filter((record) => quoteValidity(record).status === "Expiring Soon");
    const expired = records.filter((record) => quoteValidity(record).status === "Expired / Requote Required");
    return `
      <section class="tb-expiry-summary">
        <div class="tb-expiry-summary__cards">
          <article class="summary-card"><h3>Expiring Soon</h3><strong>${expiring.length}</strong><span>Within ${QUOTE_EXPIRY_WARNING_DAYS} days</span></article>
          <article class="summary-card"><h3>Expired</h3><strong>${expired.length}</strong><span>MFG / OM should requote</span></article>
        </div>
      </section>
    `;
  }

  function enhanceTempBudgetUi() {
    tbHydrate();
    tbCleanupForbiddenNodes();
    removeSourceUrlField();

    const records = tbAllRecords().filter((record) => isTempBudget(record));
    const managerBlock = tbActiveViewName() === "manager" ? document.querySelector(".view.active .temp-budget-manager-dashboard") : null;
    if (managerBlock && !managerBlock.querySelector(".tb-manager-extra")) {
      managerBlock.insertAdjacentHTML("beforeend", tempBudgetManagerSummary(records));
    }

    const procurementView = tbActiveView("procurement");
    if (procurementView && !procurementView.querySelector(".tb-expiry-summary")) {
      procurementView.insertAdjacentHTML("afterbegin", procurementExpirySummary(records));
    }

    const omView = tbActiveView("om");
    if (omView && !omView.querySelector(".tb-expiry-summary")) {
      omView.insertAdjacentHTML("afterbegin", procurementExpirySummary(records));
    }

    const activeView = document.querySelector(".view.active");
    if (!activeView) return;
    const activeViewName = tbActiveViewName();
    const canAnnotateOmRows = activeViewName === "om" && ["om", "omLeader", "omMember", "admin"].includes(tbText(globalThis.currentUserRole));
    activeView.querySelectorAll("table tbody tr").forEach((row) => {
      const text = tbText(row.innerText);
      const requestIdMatch = text.match(/REQ[-–][A-Z0-9-]+/i);
      const requestId = requestIdMatch ? requestIdMatch[0] : "";
      const record = records.find((entry) => tbRecordId(entry) === requestId);
      if (!record) return;
      if (canAnnotateOmRows && !row.querySelector(".tb-validity-card")) {
        const targetCell = row.querySelector("td:nth-last-child(2), td:nth-last-child(3)") || row.lastElementChild;
        if (targetCell) {
          targetCell.insertAdjacentHTML("beforeend", tempBudgetOmValidityCard(record));
        }
      }
    });

    document.querySelectorAll(".temp-budget-detail-block").forEach((block) => {
      if (block.querySelector(".tb-validity-inline")) return;
      const text = tbText(block.innerText);
      const requestIdMatch = text.match(/REQ[-–][A-Z0-9-]+/i);
      if (!requestIdMatch) return;
      const record = records.find((entry) => tbRecordId(entry) === requestIdMatch[0]);
      if (!record) return;
      const variance = varianceView(record);
      const validity = quoteValidity(record);
      block.insertAdjacentHTML("beforeend", `
        <div class="tb-validity-inline">
          <div><span>Bidding Amount</span><strong>${variance.bidding ? tbMoney(variance.bidding) : "Pending bidding"}</strong></div>
          <div><span>Bidding Variance</span><strong>${variance.bidding ? `${variance.biddingVarianceAmount >= 0 ? "+" : ""}${tbMoney(variance.biddingVarianceAmount)}${variance.biddingVariancePercent !== null ? ` (${(variance.biddingVariancePercent * 100).toFixed(1)}%)` : ""}` : "Pending bidding"}</strong></div>
          <div><span>PO Actual</span><strong>${variance.po ? tbMoney(variance.po) : "Pending PO"}</strong></div>
          <div><span>PO Variance</span><strong>${variance.po ? `${variance.poVarianceAmount >= 0 ? "+" : ""}${tbMoney(variance.poVarianceAmount)}${variance.poVariancePercent !== null ? ` (${(variance.poVariancePercent * 100).toFixed(1)}%)` : ""}` : "Pending PO"}</strong></div>
          <div><span>Quote Valid Until</span><strong>${tbEscape(validity.validUntil || "Pending")}</strong></div>
          <div><span>Expiry Status</span><strong>${tbEscape(validity.status)}</strong></div>
        </div>
      `);
    });
  ...
  function onValidityInput(event) {
    const input = event.target?.closest?.(".tb-validity-input");
    if (!input) return;
    tbHydrate();
    const key = input.getAttribute("data-tb-key");
    const field = input.getAttribute("data-tb-field");
    if (!key || !field) return;
    const record = tbAllRecords().find((entry) => tbRecordId(entry) === key);
    if (!record) return;
    const nextPatch = { [field]: input.value || "", quoteStatus: quoteValidity({ ...record, [field]: input.value || "" }).status };
    tbPersist(record, nextPatch);
    if (typeof addOmHistory === "function") {
      if (field === "quoteValidUntil" && input.value) {
        addOmHistory(record, "Quote validity recorded", `Quote valid until ${input.value}.`);
      }
      if (field === "quoteReceivedAt" && input.value) {
        addOmHistory(record, "Bidding result received", `Quote received on ${input.value}.`);
      }
    }
    requestAnimationFrame(enhanceTempBudgetUi);
  }

  function injectStyles() {
    if (document.getElementById("tb-validity-overlay-style")) return;
    const style = document.createElement("style");
    style.id = "tb-validity-overlay-style";
    style.textContent = `
      .tb-validity-card{margin-top:10px;padding:10px;border:1px solid #d5e1ec;background:#f8fbff}
      .tb-validity-card__title{font-weight:700;color:#1f4265;margin-bottom:8px}
      .tb-validity-card__grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px}
      .tb-validity-card__grid span{display:block;font-size:11px;text-transform:uppercase;color:#607384}
      .tb-validity-card__grid strong{display:block;font-size:13px;color:#17324d}
      .tb-validity-card__grid label{display:grid;gap:6px}
      .tb-validity-card__grid input{padding:8px 10px;font-size:13px}
      .tb-manager-extra{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px;margin-top:12px}
      .tb-expiry-summary{margin:16px 0;padding:14px;border:1px solid #c6d6e4;background:#f9fbfd}
      .tb-expiry-summary__cards{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}
      .tb-validity-inline{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:8px;margin-top:12px;padding-top:10px;border-top:1px dashed #d8c38d}
      .tb-validity-inline span{display:block;font-size:11px;text-transform:uppercase;color:#7a694c}
      .tb-validity-inline strong{display:block;font-size:13px;color:#17324d}
      @media (max-width:1100px){
        .tb-validity-card__grid,.tb-manager-extra,.tb-expiry-summary__cards,.tb-validity-inline{grid-template-columns:1fr 1fr}
      }
    `;
    document.head.appendChild(style);
  }

  function initTempBudgetQuoteValidityOverlay() {
    tbCleanupForbiddenNodes();
    // Disabled: quote validity is now rendered directly by OM Quote Completion.
    // Keeping this initializer inert prevents the old global observer from
    // injecting temporary-budget cards into Manager / OM / Admin tables.
  }

  if (document.readyState === "loading") {
    document.addEventListener("DOMContentLoaded", initTempBudgetQuoteValidityOverlay, { once: true });
  } else {
    initTempBudgetQuoteValidityOverlay();
  }
})();
...
(() => {
  ...
  const TEMP_BUDGET_STATUSES = new Set(["Submitted", "Approved", "In Progress", "Manager Approved", "Pending OM", "Waiting PAS Result", "PAS Result Received", "Waiting User A Confirmation", "Ready for Export", "Exported", "Buyer Received", "PO Issued", "Completed"]);
  const tempBudgetUiState = loadTempBudgetDraftState();
  const tempBudgetViewState = {
    managerOnly: false
  };
  ...
  function quoteValiditySnapshot(record) {
    ...
    if (daysRemaining <= 14) return { validUntil, quoteReceivedAt, status: "Expiring Soon", daysRemaining };
    return {
      validUntil,
      quoteReceivedAt,
  ...
  function tempBudgetDashboardRecords() {
    hydrateTempBudgetMetaIntoRecords();
    const records = Array.isArray(typeof purchaseRecords !== "undefined" ? purchaseRecords : []) ? purchaseRecords : [];
    return records.filter((record) => isTempBudgetRecord(record) && !["Draft", "Rejected", "Cancelled", "Cancelled by User A"].includes(recordStatusValue(record)));
  }
  ...
  function applyPendingTempBudgetToSubmittedRecords() {
    ...
    const targets = records.filter((record) => {
      ...
      if (["Draft", "Rejected", "Cancelled", "Cancelled by User A"].includes(recordStatusValue(record))) return false;
  ...
  function renderRequesterTempBudgetPanel() {
    ...
    panel.innerHTML = `
      <div class="temp-budget-panel__header">
        <div>
          <h3>Request Type</h3>
          <p>Temporary budget estimate 會跟著 submit 一路帶到 Manager B 與 OM Purchasing。</p>
        </div>
  ...
  function injectManagerTempBudgetDashboard() {
    // Disabled: temporary budget is displayed only inside OPM New Request and
    // details. Manager uses the official Demand Analysis dashboard instead.
    return;
    if (!["manager", "admin"].includes(currentUserRole || "")) return;
    const managerView = document.querySelector('[data-view="manager"].active');
    if (!managerView) return;
    const records = tempBudgetDashboardRecords();
    const totals = records.reduce((acc, record) => {
      ...
      acc.estimate += variance.estimate;
      acc.bidding += variance.bidding;
      acc.actual += variance.actual;
      if (!variance.actual) acc.pending += 1;
      if (variance.actual && Math.abs(variance.varianceAmount) > 0) acc.variance += variance.varianceAmount;
      if (validity.status === "Expiring Soon") acc.expiringSoon += 1;
      if (validity.status === "Expired / Requote Required") acc.expired += 1;
      return acc;
    }, { items: 0, estimate: 0, bidding: 0, actual: 0, variance: 0, pending: 0, expiringSoon: 0, expired: 0 });
    let section = managerView.querySelector(".temp-budget-manager-dashboard");
    const anchor = Array.from(managerView.querySelectorAll("h2,h3")).find((node) => /Demand Analysis|Approval Queue|Progress Dashboard/i.test(node.textContent || ""))?.parentElement || managerView.firstElementChild || managerView;
    if (!section) {
      section = document.createElement("section");
      section.className = "temp-budget-manager-dashboard";
      anchor.insertAdjacentElement("afterend", section);
    }
    section.innerHTML = `
      <div class="temp-budget-manager-dashboard__head">
        <div>
          <h3>Temporary Budget Tracker</h3>
          <p>Manager 第一眼先看 estimate vs PO actual，後面有疑慮再下鑽既有 matrix / detail。</p>
        </div>
        <button type="button" class="secondary-btn" id="tempBudgetManagerToggle">${tempBudgetViewState.managerOnly ? "Show All Requests" : "Temporary Budget Only"}</button>
      </div>
      <div class="temp-budget-manager-dashboard__cards">
        <article class="summary-card"><h3>Temp Budget Items</h3><strong>${totals.items}</strong><span>Submitted / approved / in progress</span></article>
        <article class="summary-card"><h3>Estimated Amount</h3><strong>${budgetMoneyFormatter(totals.estimate)}</strong><span>User A pre-budget total</span></article>
        <article class="summary-card"><h3>Bidding Amount</h3><strong>${budgetMoneyFormatter(totals.bidding)}</strong><span>Estimate vs bidding can be reviewed before PO</span></article>
        <article class="summary-card"><h3>PO Actual</h3><strong>${budgetMoneyFormatter(totals.actual)}</strong><span>Formal actual source = PO</span></article>
        <article class="summary-card"><h3>Pending PO</h3><strong>${totals.pending}</strong><span>Variance not ready yet</span></article>
        <article class="summary-card tb-manager-extra"><h3>Expiring Soon</h3><strong>${totals.expiringSoon}</strong><span>Within 14 days</span></article>
        <article class="summary-card tb-manager-extra"><h3>Expired</h3><strong>${totals.expired}</strong><span>MFG / OM should requote</span></article>
      </div>
    `;
    section.querySelector("#tempBudgetManagerToggle")?.addEventListener("click", () => {
      tempBudgetViewState.managerOnly = !tempBudgetViewState.managerOnly;
      enhanceTemporaryBudgetRows();
    });
  }

  function managerRowRequestId(row) {
    const text = normalizeBudgetText(row.innerText);
    const requestIdMatch = text.match(/REQ[-–][A-Z0-9-]+/i);
    return requestIdMatch ? requestIdMatch[0] : "";
  }
  ...
  function tempBudgetSummaryHtml(record) {
    const variance = varianceSnapshot(record);
    const validity = quoteValiditySnapshot(record);
    const biddingText = variance.bidding
      ? `${budgetMoneyFormatter(variance.bidding)}${variance.biddingVariancePercent !== null ? ` • ${variance.biddingVarianceAmount >= 0 ? "+" : ""}${budgetMoneyFormatter(variance.biddingVarianceAmount)} (${(variance.biddingVariancePercent * 100).toFixed(1)}%)` : ""}`
      : "Pending bidding";
    const poText = variance.actual
      ? `${budgetMoneyFormatter(variance.actual)}${variance.variancePercent !== null ? ` • ${variance.varianceAmount >= 0 ? "+" : ""}${budgetMoneyFormatter(variance.varianceAmount)} (${(variance.variancePercent * 100).toFixed(1)}%)` : ""}`
      : "Pending PO";
    return `
      <div class="temp-budget-inline">
        <span class="pill pill-warning">${TEMP_BUDGET_APPROVAL_TEXT}</span>
        <div class="temp-budget-inline__meta">
          <span><strong>Estimate</strong> ${budgetMoneyFormatter(record.estimatedAmount || 0)}</span>
          <span><strong>Bidding</strong> ${biddingText}</span>
          <span><strong>PO Actual</strong> ${poText}</span>
          <span><strong>Quote</strong> ${escapeBudgetHtml(validity.status)}</span>
        </div>
        ${record.estimateSource ? `<div class="temp-budget-inline__source">${escapeBudgetHtml(record.estimateSource)}</div>` : ""}
      </div>
    `;
  }

  function omTempBudgetDetailHtml(record) {
    const variance = varianceSnapshot(record);
    const validity = quoteValiditySnapshot(record);
    return `
      <div class="temp-budget-om-card">
        <div class="temp-budget-om-card__title">Temporary Budget Tracking</div>
        <div class="temp-budget-om-card__grid">
          ...
          <div><span>PO Actual Amount</span><strong>${variance.actual ? budgetMoneyFormatter(variance.actual) : "Pending PO"}</strong></div>
        ...
        <div class="temp-budget-om-card__foot">
          ${record.estimateSource ? `<span>Source: ${escapeBudgetHtml(record.estimateSource)}</span>` : ""}
          ${record.estimateDate ? `<span>Estimate date: ${escapeBudgetHtml(record.estimateDate)}</span>` : ""}
          ${validity.quoteReceivedAt ? `<span>Quote received: ${escapeBudgetHtml(validity.quoteReceivedAt)}</span>` : ""}
        </div>
      </div>
    `;
  }

  function userATempBudgetSummaryHtml(record) {
    return `
      <div class="temp-budget-inline temp-budget-inline--user">
        <span class="pill pill-warning">${TEMP_BUDGET_APPROVAL_TEXT}</span>
        <div class="temp-budget-inline__meta">
          <span><strong>Estimate</strong> ${record.estimatedAmount ? budgetMoneyFormatter(record.estimatedAmount) : "Pending"}</span>
          <span><strong>Source</strong> ${escapeBudgetHtml(record.estimateSource || "Pending")}</span>
          <span><strong>Status</strong> ${escapeBudgetHtml(recordStatusValue(record) || "Submitted")}</span>
        </div>
      </div>
    `;
  }
    ...
    return `
      <section class="temp-budget-detail-block">
        ...
        <div class="temp-budget-detail-block__grid">
          ...
          <div><span>PO Variance</span><strong>${variance.actual ? `${variance.varianceAmount >= 0 ? "+" : ""}${budgetMoneyFormatter(variance.varianceAmount)}${variance.variancePercent !== null ? ` (${(variance.variancePercent * 100).toFixed(1)}%)` : ""}` : "Pending PO"}</strong></div>
          <div><span>Quote Received</span><strong>${escapeBudgetHtml(validity.quoteReceivedAt || "Pending")}</strong></div>
          <div><span>Quote Valid Until</span><strong>${escapeBudgetHtml(validity.validUntil || "Pending")}</strong></div>
          <div><span>Expiry Status</span><strong>${escapeBudgetHtml(validity.status)}</strong></div>
        </div>
  ...
  function enhanceTemporaryBudgetRows() {
    if (typeof window.cleanupTemporaryBudgetLeakage === "function") window.cleanupTemporaryBudgetLeakage();
    renderRequesterTempBudgetPanel();
    enhanceTempBudgetDetailModals();
    // Disabled table-wide annotation. Temporary Budget UI now belongs only to
    // the OPM New Request panel and item detail views, so Manager / OM / Admin
    // tables cannot be polluted by request-side cards.
  }
  ...
  function onDocumentClickCapture(event) {
    ...
    if ((currentUserRole === "manager" || currentUserRole === "admin") && label === "approve") {
      const row = button.closest("tr");
      const requestId = row ? managerRowRequestId(row) : "";
      const record = requestId ? findRecordByRequestId(requestId) : null;
      if (record && isTempBudgetRecord(record)) {
        record.managerApprovedBudgetEstimateAt = new Date().toISOString();
        persistTempBudgetMeta(record, { managerApprovedBudgetEstimateAt: record.managerApprovedBudgetEstimateAt });
      }
    }
  }
  ...
  function installTemporaryBudgetStyles() {
    ...
    style.textContent = `
      ...
      .temp-budget-manager-dashboard{margin:16px 0 18px;padding:16px;border:1px solid #c6d6e4;background:#f9fbfd}
      .temp-budget-manager-dashboard__head{display:flex;justify-content:space-between;gap:12px;align-items:flex-start;margin-bottom:14px}
      .temp-budget-manager-dashboard__head h3{margin:0 0 4px}
      .temp-budget-manager-dashboard__head p{margin:0;color:#5b6b79}
      .temp-budget-manager-dashboard__cards{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px}
      .temp-budget-inline{margin-top:8px;padding:8px 10px;border:1px solid #e8d1a5;background:#fffaf1}
      .temp-budget-inline--user{background:#f6fbff;border-color:#c8dbee}
      .temp-budget-inline__meta{display:flex;flex-wrap:wrap;gap:10px;margin-top:6px;font-size:12px;color:#5b4d39}
      .temp-budget-inline__source{margin-top:4px;font-size:12px;color:#7a694c;overflow-wrap:anywhere}
      .temp-budget-om-card{margin-top:10px;padding:10px;border:1px solid #d5e1ec;background:#f8fbff}
      .temp-budget-om-card__title{font-weight:700;color:#1f4265;margin-bottom:8px}
      .temp-budget-om-card__grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}
      .temp-budget-om-card__grid span{display:block;font-size:11px;text-transform:uppercase;color:#607384}
      .temp-budget-om-card__grid strong{display:block;font-size:13px;color:#17324d}
      .temp-budget-om-card__foot{display:flex;flex-wrap:wrap;gap:12px;margin-top:8px;font-size:12px;color:#607384}
      ...
      @media (max-width: 1100px){
        .temp-budget-panel__grid,.temp-budget-manager-dashboard__cards,.temp-budget-om-card__grid,.temp-budget-detail-block__grid{grid-template-columns:1fr 1fr}
      }
    `;
    document.head.appendChild(style);
  }
