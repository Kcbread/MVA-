...
- Current delivery entrypoint: `03-it-handoff/current-docs/IT_DELIVERY_READINESS_20260608.md`.
- No-source official zip is prepared under `03-it-handoff/current-docs/`.
