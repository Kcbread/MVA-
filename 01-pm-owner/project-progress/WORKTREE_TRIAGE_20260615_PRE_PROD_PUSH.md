...
- Need human confirmation whether the Mac mini UAT SOP candidate should be
  promoted into official deploy docs or committed as a 01-pm-owner/project-progress record.
...
- `05-engineering-source/procurement-prototype/_doc/it-handoff-current-overview.md`
- `03-it-handoff/current-docs/IT_DELIVERY_READINESS_20260608.md`
- `03-it-handoff/current-docs/data-dictionary-en.md`
- `03-it-handoff/current-docs/frontend-functional-spec.md`
- `03-it-handoff/current-docs/uat-test-cases-en.md`
- `03-it-handoff/current-docs/ui-screen-guide-en.md`
- `03-it-handoff/current-docs/om-group-internal-test-plan-zhTW.md`
- `03-it-handoff/current-docs/shared-db-session-audit-implementation-plan-zhTW.md`
- `03-it-handoff/current-docs/procurement-role-decision-flow.drawio`
- `03-it-handoff/current-docs/it-handoff/**`
- `03-it-handoff/current-docs/IT offical handoff/**`

Untracked related files:

- `03-it-handoff/current-docs/IT_DELIVERY_LATEST_REVIEW_20260615.md`
- `03-it-handoff/current-docs/IT_official_handoff_20260615.zip`
...
- `01-pm-owner/project-progress/MAC_MINI_UAT_DEPLOY_SOP_CANDIDATE_20260615.md`
...
- Later promote relevant sections into `06-deployment/mac-mini/README.md` after review.
...
- `05-engineering-source/procurement-prototype/server.js`
- `05-engineering-source/procurement-prototype/tests/**`
- `06-deployment/mac-mini/deploy.sh`
- `06-deployment/mac-mini/docker-compose.yml`
...
1. Should the generated zip
   `03-it-handoff/current-docs/IT_official_handoff_20260615.zip` be
   committed to Git, or delivered outside Git?
2. Should the Mac mini SOP candidate be committed now as 01-pm-owner/project-progress memory,
   or first promoted into `06-deployment/mac-mini/README.md`?
